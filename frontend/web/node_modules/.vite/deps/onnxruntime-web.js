...
var require_ort_min = __commonJS({
  "node_modules/onnxruntime-web/dist/ort.min.js"(exports, module) {
    var ort = (() => {
      ...
      var $n = ((e) => typeof __require < "u" ? __require : typeof Proxy < "u" ? new Proxy(e, { get: (t, n) => (typeof __require < "u" ? __require : t)[n] }) : e)(function(e) {
      ...
      var nt = (e, t) => {
        for (var n in t)
          wn(e, n, { get: t[n], enumerable: true });
      }, Wu = (e, t, n, r) => {
        if (t && typeof t == "object" || typeof t == "function")
          for (let o of Nu(t))
            !Lu.call(e, o) && o !== n && wn(e, o, { get: () => t[o], enumerable: !(r = Vu(t, o)) || r.enumerable });
        return e;
      };
      var dt = (e) => Wu(wn({}, "__esModule", { value: true }), e);
      var xt, je, We, Gu, yr, vn = k(() => {
        "use strict";
        xt = /* @__PURE__ */ new Map(), je = [], We = (e, t, n) => {
          if (t && typeof t.init == "function" && typeof t.createInferenceSessionHandler == "function") {
            let r = xt.get(e);
            if (r === void 0)
              xt.set(e, { backend: t, priority: n });
            else {
              if (r.priority > n)
                return;
      ...
      var $r, le, xn = k(() => {
        "use strict";
        wr();
        $r = "warning", le = { wasm: {}, webgl: {}, webgpu: {}, versions: { common: _r }, set logLevel(e) {
          if (e !== void 0) {
      ...
      var Sn, Ir, Cr, Ar, Er, kr, Pr = k(() => {
        ...
        Sn = (e, t) => {
          ...
          if (n) {
            ...
            if (c != null) {
              let p = e.height, f = e.width;
              return c.drawImage(e, 0, 0, f, p), s = c.getImageData(0, 0, f, p).data, a.height = p, a.width = f, Sn(s, a);
            } else
              throw new Error("Can not access image data");
          } else {
            if (i)
        ...
        }, kr = (e, t, n) => new me({ location: "cpu-pinned", type: e, data: t, dims: n ?? [t.length] });
      });
      var Ze, lt, zr, Br, Dr = k(() => {
        "use strict";
        Ze = /* @__PURE__ */ new Map([["float32", Float32Array], ["uint8", Uint8Array], ["int8", Int8Array], ["uint16", Uint16Array], ["int16", Int16Array], ["int32", Int32Array], ["bool", Uint8Array], ["float64", Float64Array], ["uint32", Uint32Array], ["int4", Uint8Array], ["uint4", Uint8Array]]), lt = /* @__PURE__ */ new Map([[Float32Array, "float32"], [Uint8Array, "uint8"], [Int8Array, "int8"], [Uint16Array, "uint16"], [Int16Array, "int16"], [Int32Array, "int32"], [Float64Array, "float64"], [Uint32Array, "uint32"]]), zr = false, Br = () => {
          if (!zr) {
            zr = true;
            ...
            e && (Ze.set("int64", BigInt64Array), lt.set(BigInt64Array, "int64")), t && (Ze.set("uint64", BigUint64Array), lt.set(BigUint64Array, "uint64")), r ? (Ze.set("float16", n), lt.set(n, "float16")) : Ze.set("float16", Uint16Array);
          }
        };
      });
      var Or, Mr, Ur = k(() => {
      ...
      var Tt, Vr = k(() => {
        ...
        Tt = class e {
          ...
          async run(t, n, r) {
            he(), Ue("InferenceSession.run");
            let o = {}, i = {};
            if (typeof t != "object" || t === null || t instanceof ve || Array.isArray(t))
            ...
            if (typeof n == "object") {
              ...
              if (Array.isArray(n)) {
                ...
                for (let c of this.outputNames)
                  if (l.indexOf(c) !== -1) {
                    let p = n[c];
                    (p === null || p instanceof ve) && (d = true, s = false, o[c] = p);
                  }
                if (d) {
                  if (typeof r == "object" && r !== null)
                    i = r;
            ...
            for (let d in a)
              if (Object.hasOwnProperty.call(a, d)) {
                let l = a[d];
                l instanceof ve ? u[d] = l : u[d] = new ve(l.type, l.data, l.dims);
              }
            return Re("InferenceSession.run"), fe(), u;
          }
          async release() {
            return this.handler.dispose();
          }
          static async create(t, n, r, o) {
            he(), Ue("InferenceSession.create");
            let i, s = {};
            if (typeof t == "string") {
            ...
            let [a, u] = await yr(s), d = await a.createInferenceSessionHandler(i, u);
            return Re("InferenceSession.create"), fe(), new e(d);
          }
          startProfiling() {
      ...
      var Cn = {};
      nt(Cn, { InferenceSession: () => Nr, TRACE: () => ct, TRACE_EVENT_BEGIN: () => Ue, TRACE_EVENT_END: () => Re, TRACE_FUNC_BEGIN: () => he, TRACE_FUNC_END: () => fe, Tensor: () => ve, env: () => te, registerBackend: () => We });
      var ye = k(() => {
        "use strict";
        br();
        vr();
      ...
      var Kr, jr, Hu, Qr = k(() => {
        ...
        Ge();
        Ct();
        Kr = "ort-wasm-proxy-worker", jr = ((_a2 = globalThis.self) == null ? void 0 : _a2.name) === Kr;
        jr && (self.onmessage = (e) => {
          ...
          try {
            switch (t) {
              ...
              case "run": {
                ...
                Bt(r, o, i, s, new Array(s.length).fill(null), a).then((u) => {
                  u.some((d) => d[3] !== "cpu") ? postMessage({ type: t, err: "Proxy does not support non-cpu tensor location." }) : postMessage({ type: t, out: u }, Ot([...i, ...u]));
                }, (u) => {
        ...
        Hu = jr ? null : (e) => new Worker(e ?? be, { type: "classic", name: Kr });
      });
      var qu, Fu, be, Mt, En, Ku, ju, Jr, Zu, Xr, eo, Yr, to, Ct = k(() => {
        "use strict";
        It();
        qu = typeof location > "u" ? void 0 : location.origin, Fu = () => {
          var _a2, _b;
          if (true)
        ...
        }, ju = (e, t) => `${t ?? "./"}${e}`, Jr = async (e) => {
          let n = await (await fetch(e, { credentials: "same-origin" })).blob();
          return URL.createObjectURL(n);
        }, Zu = async (e) => (await import(
          /*webpackIgnore:true*/
          e
        )).default, Xr = (Qr(), dt(Zr)).default, eo = async () => {
          if (!be)
          ...
          if (o)
            return [void 0, Yr];
          {
            let i = "ort-wasm-simd-threaded.jsep.mjs", s = e ?? Ku(i, t), a = n && s && !En(s, t), u = a ? await Jr(s) : s ?? ju(i, t);
            return [a ? u : void 0, await Zu(u)];
          }
        };
      });
      var kn, Pn, Ut, no, Qu, Xu, Yu, At, ne, Ge = k(() => {
        "use strict";
        Ct();
        Pn = false, Ut = false, no = false, Qu = () => {
          ...
          let o = e.wasmPaths, i = typeof o == "string" ? o : void 0, s = o == null ? void 0 : o.mjs, a = (s == null ? void 0 : s.href) ?? s, u = o == null ? void 0 : o.wasm, d = (u == null ? void 0 : u.href) ?? u, l = e.wasmBinary, [c, p] = await to(a, i, n > 1, !!l || !!d), f = false, m = [];
          if (t > 0 && m.push(new Promise((h) => {
            ...
            p(y).then((g) => {
              Ut = false, Pn = true, kn = g, h(), c && URL.revokeObjectURL(c);
            }, (g) => {
              Ut = false, no = true, b(g);
            });
      ...
      var ro, oo = k(() => {
        ...
        ro = (e) => {
          ...
          try {
            ...
            let i = 0;
            return (e == null ? void 0 : e.tag) !== void 0 && (i = _e(e.tag, r)), n = t._OrtCreateRunOptions(o.logSeverityLevel, o.logVerbosityLevel, !!o.terminate, i), n === 0 && Y("Can't create run options."), (e == null ? void 0 : e.extra) !== void 0 && mt(e.extra, "", /* @__PURE__ */ new WeakSet(), (s, a) => {
              let u = _e(s, r), d = _e(a, r);
      ...
      var Ju, ed, td, Vt, nd, io, so = k(() => {
        ...
        Ju = (e) => {
          ...
          for (let r of t) {
            ...
            switch (o) {
              ...
              case "webgpu":
                if (o = "JS", typeof r != "string") {
                  let l = r;
                  if (l == null ? void 0 : l.preferredLayout) {
                    if (l.preferredLayout !== "NCHW" && l.preferredLayout !== "NHWC")
                      throw new Error(`preferredLayout must be either 'NCHW' or 'NHWC': ${l.preferredLayout}`);
            ...
            let s = _e(o, n), a = i.length, u = 0, d = 0;
            if (a > 0) {
              u = ne()._malloc(a * ne().PTR_SIZE), n.push(u), d = ne()._malloc(a * ne().PTR_SIZE), n.push(d);
              for (let l = 0; l < a; l++)
                ne().setValue(u + l * ne().PTR_SIZE, i[l][0], "*"), ne().setValue(d + l * ne().PTR_SIZE, i[l][1], "*");
            }
            await ne()._OrtAppendExecutionProvider(e, s, u, d, a) !== 0 && Y(`Can't append execution provider: ${o}.`);
          }
        }, io = async (e) => {
          let t = ne(), n = 0, r = [], o = e || {};
          td(o);
          try {
            let i = Ju(o.graphOptimizationLevel ?? "all"), s = ed(o.executionMode ?? "sequential"), a = typeof o.logId == "string" ? _e(o.logId, r) : 0, u = o.logSeverityLevel ?? 2;
            ...
            let l = typeof o.optimizedModelFilePath == "string" ? _e(o.optimizedModelFilePath, r) : 0;
            if (n = t._OrtCreateSessionOptions(i, !!o.enableCpuMemArena, !!o.enableMemPattern, s, !!o.enableProfiling, 0, a, u, d, l), n === 0 && Y("Can't create session options."), o.executionProviders && await nd(n, o.executionProviders, r), o.enableGraphCapture !== void 0) {
      ...
      var He, Ee, qe, rt, ft, Nt, Lt, zn, V = k(() => {
        "use strict";
        He = (e) => {
          switch (e) {
            case "int8":
        ...
        }, Nt = (e) => e === "float32" || e === "float16" || e === "int32" || e === "int64" || e === "uint32" || e === "uint8" || e === "bool" || e === "uint4" || e === "int4", Lt = (e) => e === "float32" || e === "float16" || e === "int32" || e === "int64" || e === "uint32" || e === "uint64" || e === "int8" || e === "uint8" || e === "bool" || e === "uint4" || e === "int4", zn = (e) => {
          switch (e) {
            case "none":
              return 0;
            case "cpu":
            ...
            if (false)
              try {
                ...
                if (t.code === "ERR_FS_FILE_TOO_LARGE") {
                  let { createReadStream: n } = $n("node:fs"), r = n(e), o = [];
      ...
      var rd, od, ao, uo, Wt, id, j, ke = k(() => {
        "use strict";
        V();
        rd = ["V", "I", "W", "E", "F"], od = (e, t) => {
          console.log(`[${rd[e]},${(/* @__PURE__ */ new Date()).toISOString()}]${t}`);
        }, Wt = (e, t) => {
          ao = e, uo = t;
        }, id = (e, t) => {
          let n = ft(e), r = ft(ao);
      ...
      var Dn, Pe, x, Xe, Gt, lo, co, q = k(() => {
        ...
        Dn = class {
          ...
          static calcShape(t, n, r = false) {
            ...
            if (r) {
              if (o < 2 || i < 2)
                return;
              let u = Dn.calcMatMulShape([t[o - 2], t[o - 1]], [n[i - 2], n[i - 1]]);
              if (u === void 0)
                return;
              [a[s - 2], a[s - 1]] = u;
            }
        ...
        }, lo = -34028234663852886e22, co = 34028234663852886e22;
      });
      var Ht, On = k(() => {
        "use strict";
        V();
      ...
      var mo, Un, fo, sd, po, ad, ho, qt, Ft, Mn, go, yo = k(() => {
        "use strict";
        V();
        ke();
        mo = /* @__PURE__ */ new Map([["float32", 32], ["float16", 16], ["int32", 32], ["uint32", 32], ["int64", 64], ["uint64", 64], ["int8", 8], ["uint8", 8], ["int4", 4], ["uint4", 4]]), Un = (e, t) => {
          if (t === "int32")
            return e;
          let n = mo.get(t);
          if (!n)
          ...
          let o = e.byteLength / r, i = new (rt(t))(e.buffer, e.byteOffset, o);
          switch (t) {
            case "int64":
            case "uint64": {
        ...
        }, sd = 1, po = () => sd++, ad = /* @__PURE__ */ new Map([["int8", "int32"], ["uint8", "int32"], ["uint32", "int32"], ["int64", "int32"]]), ho = (e, t) => {
          let n = mo.get(e);
          if (!n)
          ...
          async read(t) {
            if (this.fallbackDataType) {
              let n = await this.mlContext.readTensor(this.mlTensor), r = fo(new Uint8Array(n), this.dataType);
              if (t) {
          ...
          async ensureTensor(t, n, r, o) {
            let i = this.tensorManager.getMLContext(t), s;
            if (!i.opSupportLimits().input.dataTypes.includes(n)) {
              ...
              j("verbose", () => `[WebNN] TensorIdTracker.ensureTensor: fallback dataType from ${n} to ${s}`);
            }
            if (this.wrapper) {
            ...
            return this.wrapper = await this.tensorManager.getCachedTensor(t, n, r, a, true, true, s), o && this.activeUpload && (this.wrapper.write(this.activeUpload), this.activeUpload = void 0), this.wrapper.tensor;
          }
          upload(t) {
            let n = t;
            if (this.wrapper) {
              if (this.wrapper.fallbackType)
                if (this.wrapper.fallbackType === "int32")
                  n = Un(t, this.wrapper.type), this.wrapper.setIsDataConverted(true);
                else
              ...
              if (t.byteLength === this.wrapper.byteLength) {
                ...
                j("verbose", () => "Data size does not match tensor size. Releasing tensor."), this.releaseTensor();
            }
          ...
          async download(t) {
            ...
            if (this.activeUpload) {
              let n = ((_a2 = this.wrapper) == null ? void 0 : _a2.isDataConverted) ? fo(this.activeUpload, (_b = this.wrapper) == null ? void 0 : _b.type) : this.activeUpload;
              if (t) {
          ...
          async ensureTensor(t, n, r, o, i) {
            j("verbose", () => `[WebNN] TensorManager.ensureTensor {tensorId: ${n}, dataType: ${r}, shape: ${o}, copyOld: ${i}}`);
          ...
          async download(t, n) {
            j("verbose", () => `[WebNN] TensorManager.download {tensorId: ${t}, dstBuffer: ${n == null ? void 0 : n.byteLength}}`);
            let r = this.tensorTrackersById.get(t);
            if (!r)
              throw new Error("Tensor not found.");
            return r.download(n);
          ...
          registerTensor(t, n, r, o) {
            let i = this.getMLContext(t), s = po(), a = new qt({ sessionId: t, context: i, tensor: n, dataType: r, shape: o });
            return this.tensorTrackersById.set(s, new Ft(this, a)), this.externalTensors.add(a), s;
          }
          async getCachedTensor(t, n, r, o, i, s, a) {
            ...
            for (let [l, c] of this.freeTensors.entries())
              if (c.canReuseTensor(u, n, r)) {
                j("verbose", () => `[WebNN] Reusing tensor {dataType: ${n}, ${a ? `fallbackDataType: ${a},` : ""} shape: ${r}`);
                let p = this.freeTensors.splice(l, 1)[0];
                return p.sessionId = t, p;
              }
            j("verbose", () => `[WebNN] MLContext.createTensor {dataType: ${n}, ${a ? `fallbackDataType: ${a},` : ""} shape: ${r}}`);
      ...
      var Kt, ud, jt, bo = k(() => {
        ...
        yo();
        ke();
        Kt = /* @__PURE__ */ new Map([[1, "float32"], [10, "float16"], [6, "int32"], [12, "uint32"], [7, "int64"], [13, "uint64"], [22, "int4"], [21, "uint4"], [3, "int8"], [2, "uint8"], [9, "uint8"]]), ud = (e, t) => {
          if (e === t)
            return true;
          ...
          onRunEnd(t) {
            ...
            if (n) {
              for (let r of n)
                j("verbose", () => `[WebNN] releasing temporary tensor {tensorId: ${r}}`), this.tensorManager.releaseTensorId(r);
          ...
          releaseTensorId(t) {
            j("verbose", () => `[WebNN] releaseTensorId {tensorId: ${t}}`), this.tensorManager.releaseTensorId(t);
          }
          async ensureTensor(t, n, r, o, i) {
            let s = Kt.get(r);
            if (!s)
          ...
          uploadTensor(t, n) {
            ...
            j("verbose", () => `[WebNN] uploadTensor {tensorId: ${t}, data: ${n.byteLength}}`), this.tensorManager.upload(t, n);
          }
          ...
          registerMLTensor(t, n, r, o) {
            ...
            return j("verbose", () => `[WebNN] registerMLTensor {tensor: ${n}, dataType: ${i}, dimensions: ${o}} -> {tensorId: ${s}}`), s;
          }
          registerMLConstant(t, n, r, o, i, s, a = false) {
            ...
            return j("verbose", () => `[WebNN] registerMLConstant {dataType: ${i.dataType}, shape: ${i.shape}}} ${a ? "(Note: it was int64 data type and registered to int32 as workaround)" : ""}`), o.constant(i, c);
          }
          ...
          isGraphInputOutputTypeSupported(t, n, r = true) {
            let o = this.mlContextBySessionId.get(t), i = Kt.get(He(n));
            return typeof i > "u" ? false : r ? !!(o == null ? void 0 : o.opSupportLimits().input.dataTypes.includes(i)) : !!(o == null ? void 0 : o.opSupportLimits().output.dataTypes.includes(i));
          }
          flush() {
          }
        };
      ...
      var _o, Rn, Vn, dd, ld, wo, Ln, Nn, vo, xo = k(() => {
        "use strict";
        ke();
        Zt();
        _o = /* @__PURE__ */ new Map([[64, 250], [128, 200], [256, 200], [512, 200], [2048, 230], [4096, 200], [8192, 50], [16384, 50], [32768, 50], [65536, 50], [131072, 50], [262144, 50], [524288, 50], [1048576, 50], [2097152, 30], [4194304, 20], [8388608, 10], [12582912, 10], [16777216, 10], [26214400, 15], [33554432, 22], [44236800, 2], [58982400, 6], [67108864, 6], [134217728, 6], [167772160, 6]]), Rn = [], Vn = (e) => Math.ceil(Number(e) / 16) * 16, dd = (e) => {
        ...
        }, ld = 1, wo = () => ld++, Ln = async (e, t, n, r) => {
          let o = Vn(n), i = e.device.createBuffer({ size: o, usage: GPUBufferUsage.COPY_DST | GPUBufferUsage.MAP_READ });
          try {
          ...
          constructor(t) {
            ...
            for (let [n] of _o)
              Rn.push(n), this.freeBuffers.set(n, []), this.freeUniformBuffers.set(n, []);
            this.sessionCount = 0;
          }
          upload(t, n) {
            let r = n.buffer, o = n.byteOffset, i = n.byteLength, s = Vn(i), a = this.storageCache.get(t);
            if (!a)
            ...
            l.copyBufferToBuffer(u, 0, a.gpuData.buffer, 0, s), this.backend.device.queue.submit([l.finish()]), u.destroy(), j("verbose", () => `[WebGPU] GpuDataManager.upload(id=${t})`);
          }
          memcpy(t, n) {
            ...
            let i = Vn(r.originalSize), s = this.backend.getCommandEncoder();
          ...
          registerExternalBuffer(t, n, r) {
            ...
            if (r) {
              if (o = r[0], t === r[1])
                return j("verbose", () => `[WebGPU] GpuDataManager.registerExternalBuffer(size=${n}) => id=${o}, buffer is the same, skip.`), o;
              if (this.backend.capturedCommandList.has(this.backend.currentSessionId))
                throw new Error(`Registering a different external buffer under graph capture mode is not supported yet.
             Please use the previous external buffer!`);
            } else
              o = wo();
            return this.storageCache.set(o, { gpuData: { id: o, type: 0, buffer: t }, originalSize: n }), j("verbose", () => `[WebGPU] GpuDataManager.registerExternalBuffer(size=${n}) => id=${o}, registered.`), o;
          }
          unregisterExternalBuffer(t) {
            t !== void 0 && (this.storageCache.delete(t), j("verbose", () => `[WebGPU] GpuDataManager.unregisterExternalBuffer() => id=${t}`));
          }
          create(t, n = GPUBufferUsage.STORAGE | GPUBufferUsage.COPY_SRC | GPUBufferUsage.COPY_DST) {
            let r = dd(t), o, i = (n & GPUBufferUsage.STORAGE) === GPUBufferUsage.STORAGE, s = (n & GPUBufferUsage.UNIFORM) === GPUBufferUsage.UNIFORM;
            if (i || s) {
            ...
            return this.storageCache.set(a.id, { gpuData: a, originalSize: Number(t) }), j("verbose", () => `[WebGPU] GpuDataManager.create(size=${t}) => id=${a.id}`), a;
          }
          get(t) {
            var _a2;
          ...
          release(t) {
            ...
            return j("verbose", () => `[WebGPU] GpuDataManager.release(id=${n}), gpuDataId=${r.gpuData.id}`), this.storageCache.delete(n), this.buffersPending.push(r.gpuData.buffer), r.originalSize;
          }
          async download(t, n) {
          ...
          onReleaseSession(t) {
            ...
            n && (n.forEach((r) => {
              r.destroy();
            }), this.capturedPendingBuffers.delete(t)), this.sessionCount -= 1, this.sessionCount === 0 && (j("warning", () => "[WebGPU] Clearing webgpu buffer cache"), this.storageCache.forEach((r) => {
      ...
      var Ye, Hn, re, ce, P, X, qn, Je, Te, O, Qt, S, C, So, Xt, Gn, To, K = k(() => {
        "use strict";
        V();
        q();
        Ye = 64, Hn = (e, t) => {
  ...
  fn i2o_${e}(indices: ${p.indices}) -> u32 {
    return ${v.join("+")};
  }`, T = (E) => (m.indicesToOffset = true, s < 2 ? E : `i2o_${e}(${E})`), I = (...E) => s === 0 ? "0u" : `${p.indices}(${E.map(f).join(",")})`, A = (E, L) => s < 2 ? `${E}` : `${O(E, L, s)}`, z = (E, L, oe) => s < 2 ? `${E}=${oe};` : `${O(E, L, s)}=${oe};`, M = {}, U = (E, L) => {
            ...
            for (let Se = s - 1; Se >= 0; Se--) {
              ...
              $e.push(`${A(y, Se)} * (${ue} % ${A(b, Se)})`);
            }
            return M[oe] = `fn ${oe}(outputIndices: ${L.type.indices}) -> u32 {
  ...
  fn get_${e}ByIndices(indices: ${p.indices}) -> ${l} {
    return ${B(`i2o_${e}(indices)`)};
            ...
            let E = a.map((oe) => `d${oe}: u32`).join(", "), L = a.map((oe) => `d${oe}`).join(", ");
            return `
  fn get_${e}(${E}) -> ${l} {
    return get_${e}ByIndices(${I(L)});
            ...
            let L = E.map(f).join(",");
            return s === 0 ? B("0u") : s === 1 ? B(L[0]) : (m.get = true, m.getByIndices = true, m.indicesToOffset = true, `get_${e}(${L})`);
          }, Z = (E) => s < 2 ? B(E) : (m.getByIndices = true, m.indicesToOffset = true, `get_${e}ByIndices(${E})`), R = s < 2 ? "" : `
  ...
  fn set_${e}(${E}, value: ${l}) {
    set_${e}ByIndices(${I(L)}, value);
          ...
          return { impl: () => {
            let E = [], L = false;
            return m.offsetToIndices && (E.push(_), L = true), m.indicesToOffset && (E.push($), L = true), m.broadcastedIndicesToOffset && (Object.values(M).forEach((oe) => E.push(oe)), L = true), m.set && (E.push(Q), L = true), m.setByIndices && (E.push(R), L = true), m.get && (E.push(W), L = true), m.getByIndices && (E.push(ee), L = true), !i && L && E.unshift(`const ${b} = ${p.indices}(${n.join(",")});`, `const ${y} = ${p.indices}(${x.computeStrides(n).join(",")});`), E.join(`
`);
          }, type: p, offsetToIndices: w, indicesToOffset: T, broadcastedIndicesToOffset: U, indices: I, indicesGet: A, indicesSet: z, set: (...E) => {
            if (E.length !== s + 1)
              throw new Error(`indices length must be ${s}`);
            let L = E[s];
            if (typeof L != "string")
            ...
            return s === 0 ? G("0u", L) : s === 1 ? G(oe[0], L) : (m.set = true, m.setByIndices = true, m.indicesToOffset = true, `set_${e}(${oe}, ${L})`);
          }, setByOffset: G, setByIndices: (E, L) => s < 2 ? G(E, L) : (m.setByIndices = true, m.indicesToOffset = true, `set_${e}ByIndices(${E}, ${L});`), get: D, getByOffset: B, getByIndices: Z, usage: r, name: e, strides: y, shape: b, rank: s };
        }, S = (e, t, n, r = 1) => Qt(e, t, n, "input", r), C = (e, t, n, r = 1) => Qt(e, t, n, "output", r), So = (e, t, n) => Qt(e, t, n, "atomicOutput", 1), Xt = (e, t, n, r = 1) => Qt(e, t, n, "internal", r), Gn = class {
          constructor(t, n) {
...
`);
      ...
      var cd, Io, pd, md, fd, hd, pe, Co, Ao, Ve = k(() => {
        "use strict";
        V();
        q();
        ie();
        ...
        }, Io = (e, t) => t.length !== 0 ? t : [...new Array(e).keys()].reverse(), pd = (e, t) => x.sortBasedOnPerm(e, Io(e.length, t)), md = (e, t, n, r) => {
    ...
    var a: ${n.type.indices};`;
          ...
          let n = e.dataType, r = e.dims.length, o = Io(r, t), i = pd(e.dims, o), s = e.dims, a = i, u = r < 2 || hd(o, e.dims), d;
          if (u)
            return d = (h) => {
  ...
  ${h.mainStart()}
    ...
    output[global_idx] = input[global_idx];
          ...
          let { newShape: l, newPerm: c } = fd(e.dims, o), p = x.areEqual(c, [2, 3, 1]), f = x.areEqual(c, [3, 1, 2]);
          if (l.length === 2 || p || f) {
  ...
  ${h.mainStart()}
    ...
    ${y.setByOffset("global_idx", b.getByIndices("aIndices"))}
          ...
          cd(e.inputs, t.perm), e.compute(pe(e.inputs[0], t.perm));
        }, Ao = (e) => N({ perm: e.perm });
      });
      var gd, yd, bd, _d, wd, $d, vd, xd, Sd, Td, ze, Eo, ko, Po, zo, Bo, Do, Oo, Mo, Uo, Ro, Vo = k(() => {
        "use strict";
        V();
        q();
        K();
        Yt();
        Ve();
        gd = { max: "select(bestValue, candidate, candidate > bestValue)", min: "select(bestValue, candidate, candidate < bestValue)", mean: "bestValue + candidate", sum: "bestValue + candidate", prod: "bestValue * candidate", sumSquare: "bestValue + candidate * candidate", logSumExp: "bestValue + exp(candidate)", l1: "bestValue + abs(candidate)", l2: "bestValue + candidate * candidate", logSum: "bestValue + candidate" }, yd = { max: "select(bestValue, candidate, candidate > bestValue)", min: "select(bestValue, candidate, candidate < bestValue)", mean: "bestValue + candidate", sum: "bestValue + candidate", prod: "bestValue * candidate", sumSquare: "bestValue + candidate", logSumExp: "bestValue + candidate", l1: "bestValue + candidate", l2: "bestValue + candidate", logSum: "bestValue + candidate" }, bd = { max: "_A[offset]", min: "_A[offset]", mean: "0", sum: "0", prod: "1", sumSquare: "0", logSumExp: "0", l1: "0", l2: "0", logSum: "0" }, _d = { max: "bestValue", min: "bestValue", sum: "bestValue", prod: "bestValue", sumSquare: "bestValue", logSumExp: "log(bestValue)", l1: "bestValue", l2: "sqrt(bestValue)", logSum: "log(bestValue)" }, wd = (e, t) => {
          let n = [];
          for (let r = t - e; r < t; ++r)
            n.push(r);
          return n;
       ...
       `, m = (h) => `
        ...
        fn DIV_CEIL(a : u32, b : u32) -> u32 {
         ...
         if (local_idx == 0u) {
          ...
          let o = e.inputs.length === 1 ? n : Fn(e.inputs, n), i = o.axes;
          i.length === 0 && !o.noopWithEmptyAxes && (i = e.inputs[0].dims.map((f, m) => m));
          let s = x.normalizeAxes(i, e.inputs[0].dims.length), a = s, u = e.inputs[0], d = Sd(a, e.inputs[0].dims.length);
          d.length > 0 && (u = e.compute(pe(e.inputs[0], d), { inputs: [0], outputs: [-1] })[0], a = wd(a.length, u.dims.length));
          let [l, c] = $d(u.dims, a), p = l;
          o.keepDims && (p = vd(l, s)), e.compute(Td(t, o.cacheKey, [u], r, e.inputs[0].dataType, p, c), { inputs: [u] });
        }, Eo = (e, t) => {
      ...
      var Be, Id, Jt, Fn, De, Cd, Ad, Ed, kd, Pd, zd, Bd, Dd, Od, Md, Oe, No, Lo, Wo, Go, Ho, qo, Fo, Ko, jo, Zo, Yt = k(() => {
        "use strict";
        V();
        q();
        ie();
        ...
        }, Id = (e) => ["", "", `var value = ${e.getByIndices("input_indices")};`, ""], Jt = (e, t, n, r, o, i, s = false, a = false) => {
...
`)}
          ...
          let n = [];
          return e[1].dims[0] > 0 && e[1].getBigInt64Array().forEach((r) => n.push(Number(r))), N({ axes: n, keepDims: t.keepDims, noopWithEmptyAxes: t.noopWithEmptyAxes });
        }, De = (e, t, n, r) => {
          let o = e.inputs, i = o.length === 1 ? n : Fn(o, n);
          e.compute(Jt(t, { hint: i.cacheKey, inputDependencies: ["rank"] }, [o[0]], i.noopWithEmptyAxes && i.axes.length === 0 ? Id : r, i.axes, o[0].dataType, i.keepDims, i.noopWithEmptyAxes), { inputs: [0] });
        }, Cd = (e, t) => {
...
`)}`, `var value = ${r.getByIndices("input_indices")};`, `value = min(value, ${r.getByIndices("input_indices")});`, ""];
          ...
          Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? zd(e, t) : Eo(e, t);
        }, Lo = (e, t) => {
          Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Ad(e, t) : ko(e, t);
        }, Wo = (e, t) => {
          ...
          Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Bd(e, t) : Do(e, t);
        }, Fo = (e, t) => {
          ...
          Oe(e.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Cd(e, t) : Ro(e, t);
        };
      });
      var Qo, Xo, Yo, Kn, Jo = k(() => {
        "use strict";
        V();
        ie();
        Yt();
...
var best_index : i32 = 0;`, `if (${r.getByIndices("input_indices")} ${t.selectLastIndex > 0 ? "<=" : "<"} value) {
         ...
         best_index = i32(last_index);
          ...
          e.compute(Jt("ArgMin", { hint: t.cacheKey, inputDependencies: ["rank"] }, [e.inputs[0]], n, [t.axis], 7, t.keepDims), { inputs: [0] });
        }, Yo = (e, t) => {
          Qo(e.inputs);
          let n = (r, o, i) => {
            let s = [];
...
var best_index : i32 = 0;`, `if (${r.getByIndices("input_indices")} ${t.selectLastIndex > 0 ? ">=" : ">"} value) {
         ...
         best_index = i32(last_index);
          ...
          e.compute(Jt("argMax", { hint: t.cacheKey, inputDependencies: ["rank"] }, [e.inputs[0]], n, [t.axis], 7, t.keepDims), { inputs: [0] });
        }, Kn = (e) => N(e);
      });
      var Ud, jn, Rd, Vd, Nd, ot, Ld, ei, en = k(() => {
        "use strict";
        V();
        q();
        Zt();
    ...
    if (sum == 0) {
      ...
      ${s ? `
        for (var total_seq_id: u32 = seq_causal_length; total_seq_id + local_offset < uniforms.total_sequence_length; total_seq_id++) {
          ...
          let I = (A) => {
            let z = S("q", t.dataType, t.dims, b), M = S("key", n.dataType, n.dims, b), U = [z, M];
            if (v) {
            ...
            G && U.push(G);
            let B = u ? S("total_sequence_length_input", u.dataType, u.dims) : void 0;
            B && U.push(B);
            let ee = C("output", t.dataType, l), W = [ee];
            c && W.push(C("present_key", t.dataType, f, b));
            let D = ce(1, b), Z = [{ name: "M", type: "u32" }, { name: "K", type: "u32" }, { name: "N", type: "u32" }, { name: "num_heads", type: "u32" }, { name: "head_size", type: "u32" }, { name: "alpha", type: "f32" }, { name: "past_sequence_length", type: "u32" }, { name: "kv_sequence_length", type: "u32" }, { name: "n_reps", type: "u32" }];
            return `
  const TILE_SIZE = ${g}u;
  ...
  ${$.mainStart([h, h, 1])}
   ...
   if (m < uniforms.M && n < uniforms.N) {
     ...
     output[outputIdx] = value;
        ...
        }, ot = (e, t, n, r, o, i, s, a, u, d, l = void 0, c = void 0) => {
          ...
          let y = e.compute(Vd(p, t, n, s, h, d, f, l, c), { inputs: b, outputs: p > 1 ? [-1, 1] : [-1] })[0];
          e.compute(Rd(y, d.batchSize, d.numHeads, f, d.sequenceLength, m, l, c), { inputs: l && c ? [y, l, c] : [y], outputs: [] });
          let g = [y, r];
          p > 1 && a && x.size(a.dims) > 0 && g.push(a), l && g.push(l), c && g.push(c), e.compute(Nd(p, y, r, a, d, f, l, c), { inputs: g, outputs: p > 1 ? [0, 2] : [0] });
        }, Ld = (e, t) => {
  ...
  ${c.mainStart([s, s, 1])}
    ...
    if (m < uniforms.M && n < uniforms.N) {
      ...
      output_v[outputIdx] = valueV;
          ...
          let n = Ud(e.inputs, t), [r, o, i] = Ld(e, n);
          return ot(e, r, o, i, e.inputs[4], void 0, void 0, void 0, e.inputs[5], n);
        };
      });
      var Wd, Gd, Hd, ti, ni = k(() => {
        "use strict";
        ye();
        V();
        q();
        ...
        Wd = (e, t) => {
          ...
          let { epsilon: n, spatial: r, format: o } = t, i = e[0].dims, s = r ? X(i[i.length - 1]) : 1, a = o === "NHWC" && i.length > 1 ? s : 1, u = x.size(i) / s, d = r, l = d ? i.length : i, c = S("x", e[0].dataType, e[0].dims, s), p = S("scale", e[1].dataType, e[1].dims, a), f = S("bias", e[2].dataType, e[2].dims, a), m = S("inputMean", e[3].dataType, e[3].dims, a), h = S("inputVar", e[4].dataType, e[4].dims, a), b = C("y", e[0].dataType, l, s), y = () => {
            let _ = "";
            if (r)
  ...
  ${_.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
    ...
    ${b.setByOffset("global_idx", "value")}
          ...
          let { inputs: n, outputCount: r } = e, o = Hd({ ...t, outputCount: r });
          if (te.webgpu.validateInputContent && Wd(n, o), t.trainingMode)
  ...
  ${l.mainStart()}
    ...
    ${u.setByOffset("global_idx", "value")}
      ...
      var Kd, J, ii, si, ai, ui, di, li, ci, pi, mi, jd, fi, hi, gi, yi, gt, bi, tn, _i, wi, $i, vi, xi, Si, Ti, Ii, Ci, Ai, Ei, ki, Pi, zi, Bi, Di, Oi, Mi, Zn, Qn, Ui, Ri, Vi, Zd, Qd, Ni, nn = k(() => {
        "use strict";
        V();
        q();
        ie();
  ...
  ${e.mainStart()}
    ...
    ${l.setByOffset("global_idx", u)}
          ...
          return s && u.push(...s), { name: t, shaderCache: { hint: o, inputDependencies: ["type"] }, getShaderSource: (d) => Kd(d, x.size(e.dims), e.dataType, i, n, r, a), getRunData: (d) => ({ outputs: [{ dims: e.dims, dataType: i }], dispatchGroup: { x: Math.ceil(x.size(d[0].dims) / 64 / 4) }, programUniforms: u }) };
        }, ii = (e) => {
          ...
          let n = t || jd(e.inputs), r = ce(e.inputs[0].dataType);
          e.compute(J(e.inputs[0], "Clip", (o) => `clamp(${o}, vec4<${r}>(uniforms.min), vec4<${r}>(uniforms.max))`, void 0, n.cacheKey, void 0, [{ type: e.inputs[0].dataType, data: n.min }, { type: e.inputs[0].dataType, data: n.max }], [{ name: "min", type: r }, { name: "max", type: r }]), { inputs: [0] });
        }, hi = (e) => {
          ...
          e.compute(J(e.inputs[0], "Elu", (r) => `elu_vf32(${r})`, `
...
fn erf_vf32(v: vec4<${e}>) -> vec4<${e}> {
  ...
  return sign(v) * (1.0 - ((((r5 * x + r4) * x + r3) * x + r2) * x + r1) * x * exp(-absv * absv));
          ...
          let t = ce(e.inputs[0].dataType);
          e.compute(J(e.inputs[0], "Gelu", (n) => `0.5 * ${n} * (1.0 + erf_vf32(${n} * 0.7071067811865475))`, tn(t)));
        }, xi = (e, t) => {
          let n = ce(e.inputs[0].dataType);
          e.compute(J(e.inputs[0], "LeakyRelu", (r) => `select(leaky_relu_alpha_ * ${r}, ${r}, ${r} >= vec4<${n}>(0.0))`, `const leaky_relu_alpha_ = ${n}(${t.alpha});`, t.cacheKey));
        }, Si = (e) => {
          ...
          let t = ce(e.inputs[0].dataType);
          e.compute(J(e.inputs[0], "Relu", (n) => `select(vec4<${t}>(0.0), ${n}, ${n} > vec4<${t}>(0.0))`));
        }, Ai = (e) => {
          e.compute(J(e.inputs[0], "Sigmoid", (t) => `(1.0 / (1.0 + exp(-${t})))`));
        }, Ei = (e) => N(e), ki = (e, t) => {
          let n = ce(e.inputs[0].dataType);
          e.compute(J(e.inputs[0], "HardSigmoid", (r) => `max(vec4<${n}>(0.0), min(vec4<${n}>(1.0), ${t.alpha} * ${r} + vec4<${n}>(${t.beta})))`, void 0, t.cacheKey));
        }, Pi = (e) => {
        ...
        }, Oi = (e) => `sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`, Mi = (e) => {
...
`, Qn = (e) => `(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`, Ui = (e) => {
          let t = ce(e.inputs[0].dataType);
          e.compute(J(e.inputs[0], "FastGelu", Qn, Zn(t), void 0, e.inputs[0].dataType));
        }, Ri = (e, t) => {
          let n = ce(e.inputs[0].dataType);
          return e.compute(J(e.inputs[0], "ThresholdedRelu", (r) => `select(vec4<${n}>(0.0), ${r}, ${r} > thresholded_relu_alpha_)`, `const thresholded_relu_alpha_ = vec4<${n}>(${t.alpha});`, t.cacheKey)), 0;
        }, Vi = (e) => {
...
`, Qd = (e) => `quick_gelu_impl(${e})`, Ni = (e, t) => {
          let n = ce(e.inputs[0].dataType);
          e.compute(J(e.inputs[0], "QuickGelu", Qd, Zd(n, t.alpha), t.cacheKey, e.inputs[0].dataType));
        };
      });
      var Xd, Yd, Wi, Gi = k(() => {
        "use strict";
  ...
  ${u.mainStart()}
    ...
    ${o.setByOffset("global_idx", "valueLeft * geluRight")}
      ...
      var Jd, el, Me, Hi, qi, Fi, Ki, ji, Zi, Qi, Xi, Yi, Ji, es = k(() => {
        "use strict";
        V();
        q();
        K();
        ...
        ${y}
          ...
          let a = n.dims.map((h) => Number(h) ?? 1), u = r.dims.map((h) => Number(h) ?? 1), d = !x.areEqual(a, u), l = a, c = x.size(a), p = false, f = false, m = [d];
          if (d) {
            ...
            p = true;
          return m.push(p), { name: e, shaderCache: { hint: t + m.map((h) => h.toString()).join("_"), inputDependencies: ["rank", "rank"] }, getShaderSource: (h) => Jd(h, a, u, l, p, d, f, o, n.dataType, r.dataType, s, i), getRunData: () => ({ outputs: [{ dims: l, dataType: s }], dispatchGroup: { x: Math.ceil(c / 64 / 4) }, programUniforms: [{ type: 12, data: Math.ceil(x.size(l) / 4) }, ...P(a, u, l)] }) };
        }, Me = (e, t, n, r, o, i) => {
      ...
      var Ie, Ce, Ae, rn, Fe = k(() => {
        ...
        `;
          ...
          if (t === "HardSigmoid") {
            ...
            let [n, r] = (e == null ? void 0 : e.activation_params) || [lo, co];
...
`;
        }, sn = (e, t, n, r, o = false, i) => {
          let s = e[0].dims, a = e[1].dims, u = s[s.length - 2], d = a[a.length - 1], l = s[s.length - 1], c = X(d), p = X(l), f = X(u), m = x.size(n) / c / f, h = e.length > 2, b = r ? r.slice(0, -2) : n.slice(0, -2), g = [x.size(b), u, d], _ = [{ type: 12, data: m }, { type: 12, data: u }, { type: 12, data: d }, { type: 12, data: l }];
          Ce(t, _), _.push(...P(b, s, a)), h && _.push(...P(e[2].dims)), _.push(...P(g));
          let w = (v) => {
            let $ = Xt("batch_dims", e[0].dataType, b.length), T = S("a", e[0].dataType, s.length, p), I = S("b", e[1].dataType, a.length, c), A = C("output", e[0].dataType, g.length, c), z = re(A.type.tensor), M = Ie(t, A.type.value, z), U = [T, I], G = "";
            if (h) {
              let W = o ? c : 1;
              U.push(S("bias", e[2].dataType, e[2].dims.length, W)), G = `${o ? `value += bias[col / ${W}];` : `value += ${A.type.value}(bias[row + i]);`}`;
            }
...
`;
  ...
  `;
      ...
      var sl, al, Xn, as, ul, Yn, dl, bt, un = k(() => {
        "use strict";
        V();
        q();
        K();
        ...
        }`, Xn = (e, t, n = "f32", r, o = false, i = 32, s = false, a = 32) => {
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      mm_write(batch, globalRow + innerRow, globalCol, acc[innerRow]);
            ...
            `, ul = (e) => e ? "let ACached = mm_Asub[k][tileRow + innerRow];" : "let ACached = mm_Asub[tileRow + innerRow][k];", Yn = (e, t, n = "f32", r, o = false, i = 32, s = false, a = 32, u = false) => {
...
`;
    ...
    `;
          ...
          let U = (G) => {
            let B = l.length, ee = Xt("batchDims", e[0].dataType, B, 1), W = re(e[0].dataType), D = S("a", e[0].dataType, v, _), Z = S("b", e[1].dataType, T, _), R = C("result", e[0].dataType, I.length, _), Q = [D, Z];
            if (M) {
              let L = o ? _ : 1;
            ...
            Ae(t, we);
            let se = re(R.type.tensor), H = Ie(t, R.type.value, se), E = dl(_, M, H, [ee, D, Z, R], o);
            return `
  ...
  ${h ? Xn(b, y, W, ee) : Yn(b, y, W, ee)}
          ...
          return { name: "MatMul", shaderCache: { hint: `${b};${t.activation};${h};${o}`, inputDependencies: z }, getRunData: () => ({ outputs: [{ dims: i ? i(n) : n, dataType: e[0].dataType }], dispatchGroup: { x: g[0], y: g[1], z: g[2] }, programUniforms: A }), getShaderSource: U };
        };
      });
      var ll, us, ds = k(() => {
        "use strict";
        ...
        ss();
        un();
        ll = (e, t, n, r, o = false, i, s = 4, a = 4, u = 4, d = "f32") => {
          let l = (z) => {
            switch (z) {
              case 1:
    ...
    return ${de(a, d)}(0.0);`, v = de(u, d), $ = e ? de(s, d) : de(a, d), T = e ? de(a, d) : de(s, d), I = Ie(i, v, d);
          return `
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${v}) {
      ...
      setOutputAtCoords(coords[0], coords[1], coords[2], coords[3], value);
          ...
          let v = h ? d && l % 4 !== 0 ? 3 : 4 : 1, $ = g[1] * _[1], T = g[0] * _[0], I = Math.max(g[0] * v, g[1]), A = r % $ === 0, z = o % T === 0, M = i % I === 0, U = h ? [v, 4, 4] : [1, 1, 1], G = [{ type: 6, data: r }, { type: 6, data: o }, { type: 6, data: i }, { type: 6, data: [t.pads[0], t.pads[1]] }, { type: 6, data: t.strides }, { type: 6, data: t.dilations }];
          Ce(t, G), G.push(...P(e[0].dims, e[1].dims));
          let B = ["rank", "rank"];
          s && (G.push(...P(e[2].dims)), B.push("rank")), G.push(...P(n));
          let ee = (W) => {
            let D = [{ name: "dim_a_outer", type: "i32" }, { name: "dim_b_outer", type: "i32" }, { name: "dim_inner", type: "i32" }, { name: "pad", type: "i32", length: 2 }, { name: "stride", type: "i32", length: 2 }, { name: "dilation", type: "i32", length: 2 }];
            Ae(t, D);
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${h ? `vec4<${R}>` : R}) {
      ...
      }`, we = S("x", e[0].dataType, e[0].dims.length, v === 3 ? 1 : v), se = S("w", e[1].dataType, e[1].dims.length, Z), H = [we, se], E = C("result", e[0].dataType, n.length, Z);
            if (s) {
        ...
        ${h ? Xn(_, g, R, void 0, !d, I) : Yn(_, g, R, void 0, !d, I, false, void 0, a)}`;
          };
          return { name: "Conv2DMatMul", shaderCache: { hint: `${t.cacheKey};${v};${h};${A};${z};${M};${$};${T};${I}`, inputDependencies: B }, getRunData: () => ({ outputs: [{ dims: u ? u(n) : n, dataType: e[0].dataType }], dispatchGroup: { x: w[0], y: w[1], z: w[2] }, programUniforms: G }), getShaderSource: ee };
        };
      });
      var cl, ls, dn, pl, cs, ml, ps, ms, fs = k(() => {
        "use strict";
        V();
        ke();
        q();
        ...
        cl = (e) => {
          ...
          for (let n = 0; n < e.length; n++)
            t *= e[n];
          return t;
        }, ls = (e) => typeof e == "number" ? [e, e, e] : e, dn = (e, t) => t <= 1 ? e : e + (e - 1) * (t - 1), pl = (e, t, n, r = 1) => {
          let o = dn(t, r);
        ...
        }, ps = (e, t, n, r, o, i = false, s = "channelsLast") => {
          let a, u, d, l, c;
          if (s === "channelsLast")
            [a, u, d, l, c] = e;
          ...
          let [p, , f, m, h] = t, [b, y, g] = ls(n), [_, w, v] = ls(r), $ = dn(f, _), T = dn(m, w), I = dn(h, v), { padInfo: A, outDepth: z, outHeight: M, outWidth: U } = ml(o, u, d, l, b, y, g, $, T, I), G = i ? p * c : p, B = [0, 0, 0, 0, 0];
          return s === "channelsFirst" ? B = [a, G, z, M, U] : s === "channelsLast" && (B = [a, z, M, U, G]), { batchSize: a, dataFormat: s, inDepth: u, inHeight: d, inWidth: l, inChannels: c, outDepth: z, outHeight: M, outWidth: U, outChannels: G, padInfo: A, strideDepth: b, strideHeight: y, strideWidth: g, filterDepth: f, filterHeight: m, filterWidth: h, effectiveFilterDepth: $, effectiveFilterHeight: T, effectiveFilterWidth: I, dilationDepth: _, dilationHeight: w, dilationWidth: v, inShape: e, outShape: B, filterShape: t };
        }, ms = (e, t, n, r, o, i) => {
          let s = i === "channelsLast", a = s ? e[0].dims[3] : e[0].dims[1], u = false, d = [64, 1, 1], l = { x: n.map((g, _) => _) }, c = [Math.ceil(cl(l.x.map((g) => n[g])) / d[0]), 1, 1];
      ...
      var hs, gs, ys = k(() => {
        ...
        Fe();
        hs = (e, t, n, r) => {
          let o = e.length > 2, i = o ? "value += b[output_channel];" : "", s = e[0].dims, a = e[1].dims, u = t.format === "NHWC", d = u ? n[3] : n[1], l = d / t.group, c = u && l >= 4 ? X(d) : 1, p = x.size(n) / c, f = [{ type: 12, data: p }, { type: 12, data: t.dilations }, { type: 12, data: [t.strides[0], t.strides[1]] }, { type: 12, data: [t.pads[0], t.pads[1]] }, { type: 12, data: l }];
  ...
  ${b.mainStart()}
    ...
    ${y.setByOffset("global_idx", "value")}
          ...
          let o = e.length > 2, i = X(n[3]), s = X(n[2]), a = x.size(n) / i / s, u = [e[0].dims[0], e[0].dims[1], e[0].dims[2], e[0].dims[3] / i], d = [e[1].dims[0], e[1].dims[1], e[1].dims[2], e[1].dims[3] / i], l = [n[0], n[1], n[2], n[3] / i], c = [{ type: 12, data: a }, { type: 6, data: [t.strides[0], t.strides[1]] }, { type: 6, data: [t.pads[0], t.pads[1]] }];
  ...
  ${m.mainStart()}
    ...
    for (var i = 0u; i < ${s}u; i++) {
      ...
      var fl, Jn, hl, er, tr, bs, gl, yl, nr, _s = k(() => {
        "use strict";
        q();
        ds();
        fs();
        ...
        fl = (e, t, n, r, o, i) => {
          ...
          let r = e.pads.slice();
          Xe.adjustPadsBasedOnAutoPad(t[0].dims, e.strides, e.dilations, n, r, e.format === "NHWC", e.autoPad);
          let o = Object.assign({}, e);
          return Object.assign(o, { kernelShape: n, pads: r }), o;
        }, tr = (e) => {
          let t = rn(e), n = e.format, r = ["NOTSET", "VALID", "SAME_UPPER", "SAME_LOWER"][e.auto_pad], o = e.dilations, i = e.group, s = e.kernel_shape, a = e.pads, u = e.strides, d = e.w_is_const();
          return { autoPad: r, format: n, dilations: o, group: i, kernelShape: s, pads: a, strides: u, wIsConst: d, ...t, cacheKey: `${e.format};${t.activation};` };
        }, bs = (e, t, n, r) => {
          let o = n.format === "NHWC", i = fl(t[0].dims, t[1].dims, n.dilations, n.pads, n.strides, o);
          if (n.group !== 1) {
            let $ = [t[0]];
            if (o) {
              let I = e.kernelCustomData.wT ?? e.compute(pe(t[1], Jn), { inputs: [1], outputs: [n.wIsConst ? -2 : -1] })[0];
              n.wIsConst && !e.kernelCustomData.wT && (e.kernelCustomData.wT = I), $.push(I);
            } else
              $.push(t[1]);
            t.length === 3 && $.push(t[2]), !e.adapterInfo.isArchitecture("ampere") && o && t[1].dims[0] === n.group && t[1].dims[1] === 1 && n.dilations[0] === 1 && n.dilations[1] === 1 ? e.compute(gs($, n, i, r), { inputs: $ }) : e.compute(hs($, n, i, r), { inputs: $ });
            return;
          }
          ...
          if (h || l === 1 && c === 1 && n.dilations[0] === 1 && n.dilations[1] === 1 && n.strides[0] === 1 && n.strides[1] === 1 && n.pads[0] === 0 && n.pads[1] === 0) {
            let $ = i[0], T, I, A, z = [];
            if (o) {
              let G = e.kernelCustomData.wT ?? e.compute(pe(t[1], Jn), { inputs: [1], outputs: [n.wIsConst ? -2 : -1] })[0];
              if (n.wIsConst && !e.kernelCustomData.wT && (e.kernelCustomData.wT = G), h) {
                let B = a * u * d;
                T = t[0].reshape([1, $, B]), I = G.reshape([1, B, m]), A = [1, $, m];
              } else
                T = t[0].reshape([$, a * u, d]), I = G.reshape([1, d, m]), A = [$, p * f, m];
              z.push(T), z.push(I);
            } else
              T = t[0].reshape([$, d, a * u]), I = t[1].reshape([1, m, d]), A = [$, m, p * f], z.push(I), z.push(T);
            s && z.push(t[2]);
            let M = A[2], U = z[0].dims[z[0].dims.length - 1];
            M < 8 && U < 8 ? e.compute(sn(z, n, i, A, o, r), { inputs: z }) : e.compute(bt(z, n, i, A, o, r), { inputs: z });
            return;
          }
          let b = true, y = e.kernelCustomData.wT ?? e.compute(pe(t[1], Jn), { inputs: [1], outputs: [n.wIsConst ? -2 : -1] })[0];
          ...
          let o = [0, t.pads[0], 0, t.pads[1]], i = [1].concat(t.strides), s = [1].concat(t.dilations), a = [1].concat(t.kernelShape), u = er({ ...t, pads: o, strides: i, dilations: s, kernelShape: a }, r);
          bs(e, r, u, (d) => n ? [d[0], d[2], d[3]] : [d[0], d[1], d[3]]);
        }, yl = (e, t, n) => {
          let r = n.format === "NHWC" ? "channelsLast" : "channelsFirst", o = er(n, t), i = n.autoPad === "NOTSET" ? n.pads : n.autoPad, s = ps(t[0].dims, t[1].dims, n.strides, n.dilations, i, false, r);
          e.compute(ms(t, o, s.outShape, [s.filterDepth, s.filterHeight, s.filterWidth], [s.padInfo.front, s.padInfo.top, s.padInfo.left], r));
        }, nr = (e, t) => {
          if (hl(e.inputs, t), e.inputs[0].dims.length === 3)
            gl(e, t);
      ...
      var ws, $s = k(() => {
        ...
        K();
        ws = (e, t, n) => {
          let r = e.length > 2, o = t.outputShape, i = t.format === "NHWC", s = t.group, a = e[1].dims, u = a[2] / s, d = a[3], l = i ? X(u) : 1, c = i && d === 1 && u >= 4, p = c ? Math.floor(u / 4) * 4 : Math.floor(u / l) * l, f = u - p, m = i ? X(d) : 1, h = i ? d === 1 ? l : m : 1, b = x.size(o) / m, y = [Math.ceil(b / 64), 1, 1];
          ...
          let A = (z) => {
            let M = [{ name: "output_size", type: "u32" }, { name: "strides", type: "u32", length: _.length }, { name: "filter_dims", type: "u32", length: w.length }, { name: "dilations", type: "u32", length: w.length }, { name: "effective_filter_dims", type: "u32", length: $.length }, { name: "pads", type: "i32", length: T.length }, { name: "input_channels_per_group_int", type: "u32" }, { name: "input_channels_per_group", type: "u32" }, { name: "output_channels_per_group", type: "u32" }], U = re(e[0].dataType), G = i ? 1 : 2, B = i ? 2 : 3, ee = i ? 3 : 1, W = S("W", e[1].dataType, e[1].dims.length, h), D = S("Dy", e[0].dataType, e[0].dims.length, l), Z = [D, W];
            r && Z.push(S("bias", e[2].dataType, [o[ee]].length, m));
            let R = C("result", e[0].dataType, o.length, m), Q = () => {
              let H = "";
              if (c)
                l === 4 ? H += `
          ...
          dotProd = dotProd + xValue * wValue;`;
            ...
            dotProd = dotProd + xValue[${E}] * wValue${E};`;
              ...
              if (l === 1) {
                ...
                for (let E = 0; E < f; E++)
                  H += `
            + ${D.getByOffset(`x_offset + ${E}`)} * ${W.getByOffset(`w_offset + ${E}`)}`;
                H += ";";
              } else if (l === 2) {
                if (f !== 2)
    ...
    ${se}}`;
      ...
      var bl, _l, wl, vs, xs, $l, Ss, vl, Ts, Is = k(() => {
        "use strict";
        $s();
        Fe();
        Ve();
        bl = (e, t, n, r, o, i) => (e - 1) * t + n + (r - 1) * o + 1 - i, _l = (e, t, n, r, o) => {
          ...
          for (let m = 0, h = e.length - l - (a ? 1 : 0); m < l; ++m, ++h) {
            let b = e[h], y = c ? b * s[m] : d[m], g = bl(b, s[m], i[m], t[h], n[m], y);
            _l(g, r, i, m, m + l), c && d.push(s[m] * (b - 1) + u[m] + (t[h] - 1) * n[m] + 1 - i[m] - i[m + l]);
          }
          ...
          let t = rn(e), n = e.format, r = ["NOTSET", "VALID", "SAME_UPPER", "SAME_LOWER"][typeof e.autoPad > "u" ? 0 : e.autoPad], o = e.dilations, i = e.group, s = e.kernelShape, a = e.pads, u = e.strides, d = e.wIsConst(), l = e.outputPadding, c = e.outputShape;
          ...
          u = [0].concat(u);
          let d = vs({ ...t, pads: a, strides: s, dilations: i, kernelShape: o, outputPadding: u }, r);
          Ss(e, r, d, (l) => n ? [l[0], l[2], l[3]] : [l[0], l[1], l[3]]);
        }, Ts = (e, t) => {
          if ($l(e.inputs, t), e.inputs[0].dims.length === 3)
            vl(e, t);
          else {
            let n = vs(t, e.inputs);
            Ss(e, e.inputs, n);
      ...
      var xl, Cs, As, Es = k(() => {
        ...
        xl = (e, t, n, r) => {
          let o = x.size(t), i = t.length, s = S("input", e, i), a = C("output", e, i), u = n.dataType === 6 ? n.getInt32Array()[0] : Number(n.getBigInt64Array()[0]), d = x.normalizeAxis(u, i), l = (c) => {
            let p = ` i32(${s.indicesGet("inputIndices", "uniforms.axis")}) `, f = O("uniforms.input_shape", "uniforms.axis", i), m = r.reverse ? p + (r.exclusive ? " + 1" : "") : "0", h = r.reverse ? f : p + (r.exclusive ? "" : " + 1");
            return `
...
`);
  ...
  ${y.mainStart()}
    ...
    ${h.setByOffset("global_idx", m.getByIndices("aIndices"))}
        ...
        }, Ps = (e) => N({ blocksize: e.blocksize, mode: e.mode, format: e.format });
      });
      var rr, ln, Bs, Cl, Al, or, ir, Ds, El, Os, Ms, Us = k(() => {
        "use strict";
        V();
        q();
        ie();
        K();
        rr = "[a-zA-Z]|\\.\\.\\.", ln = "(" + rr + ")+", Bs = "^" + ln + "$", Cl = "(" + ln + ",)*" + ln, Al = "^" + Cl + "$", or = class {
          constructor(t = -1) {
          ...
          constructor(t, n) {
            ...
            else if (!o.match(RegExp(ln)))
              throw new Error("Invalid RHS");
            (_a2 = o.match(RegExp(rr, "g"))) == null ? void 0 : _a2.forEach((a) => {
              if (a === "...")
          ...
          processTerm(t, n, r, o = -1) {
            ...
            if (!t.match(RegExp(Bs)) && !n && t !== "")
              throw new Error("Invalid LHS term");
            let d = t.match(RegExp(rr, "g")), l = new or(o);
          ...
          let i = e.map((l) => l.length).map((l, c) => S(`input${c}`, t, l)), s = x.size(r), a = C("output", t, r.length), u = [...n.symbolToInfo.keys()].filter((l) => !n.rhs.symbolToIndices.has(l)), d = (l) => {
            ...
            n.symbolToInfo.forEach((v, $) => {
              ...
              if (n.rhs.symbolToIndices.has($)) {
                let T = (_a2 = n.rhs.symbolToIndices.get($)) == null ? void 0 : _a2[0];
                T !== void 0 && n.lhs.forEach((I, A) => {
                  if (v.inputIndices.includes(A)) {
                    ...
                    z.forEach((M) => {
                      c.push(`${i[A].indicesSet(`input${A}Indices`, M, a.indicesGet("outputIndices", T))}`);
                    });
                  }
                });
              } else
                ...
                }), b.push(`for(var ${$}: u32 = 0; ${$} < uniforms.${Ds($)}; ${$}++) {`), y.push("}");
            });
...
`)};
          ...
          let n = new ir(e.inputs, t.equation), r = n.outputDims, o = e.inputs.map((i, s) => i.dims);
          e.compute(El(o, e.inputs[0].dataType, n, r));
        }, Ms = (e) => {
          let t = e.equation.replace(/\s+/g, "");
          return N({ equation: t });
        };
      });
      var kl, Rs, Pl, zl, Vs, Ns = k(() => {
        "use strict";
        V();
        q();
        K();
        kl = (e) => {
          ...
          return r;
        }, Pl = (e, t) => e.length > t.length ? Rs(e, t) : Rs(t, e), zl = (e) => {
          let t = e[0].dims, n = Array.from(e[1].getBigInt64Array(), Number), r = Pl(t, n), o = e[0].dataType, i = o === 9 || x.size(t) === 1, s = o === 9 || t.length > 0 && t[t.length - 1] % 4 === 0 ? 4 : 1, a = i || r.length > 0 && r[r.length - 1] % 4 === 0 ? 4 : 1, u = Math.ceil(x.size(r) / a), d = (c) => {
    ...
    ${m}`;
          ...
          kl(e.inputs), e.compute(zl(e.inputs), { inputs: [0] });
        };
      });
      var Bl, Ls, Ws = k(() => {
        "use strict";
    ...
    ${s.mainStart(Ye)}
      ...
      ${d.setByOffset("global_idx", Qn("x_in"))}
          ...
          return { name: "FastGeluWithBias", shaderCache: { hint: `${o}`, inputDependencies: ["type", "type"] }, getShaderSource: i, getRunData: (s) => ({ outputs: [{ dims: s[0].dims, dataType: s[0].dataType }], programUniforms: [{ type: 12, data: Math.ceil(n / 4) }, { type: 12, data: r }], dispatchGroup: { x: Math.ceil(n / Ye / 4) } }) };
        }, Ls = (e) => {
          e.inputs.length < 2 || x.size(e.inputs[1].dims) === 0 ? Ui(e) : e.compute(Bl(e.inputs));
        };
      });
      var Dl, Ol, Gs, Hs, qs = k(() => {
        "use strict";
        V();
        q();
        ie();
        ...
        `;
              for (let v = 0, $ = 0; v < o; v++)
                v === i ? (w += `${o > 1 ? `dataIndices${g}[${v}]` : `dataIndices${g}`} = u32(idx${g});`, $ += _) : (w += `${o > 1 ? `dataIndices${g}[${v}]` : `dataIndices${g}`} = ${s.length > 1 ? `outputIndices${g}[${$}]` : `outputIndices${g}`};`, $++);
              return w;
            }, y;
            if (e[0].dataType === 9) {
              let g = (_, w, v = "") => `
      ...
      ${p.mainStart()}
        ...
        }, Gs = (e) => N({ axis: e.axis }), Hs = (e, t) => {
          let n = e.inputs;
          Dl(n), e.compute(Ol(e.inputs, t));
        };
      });
      var Ml, Fs, Ks, js = k(() => {
        "use strict";
  ...
  ${p.mainStart()}
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
          ...
          let m = Ml(e, n[1], p, t.batchDims, r, a, c, l, s), h = t.batchDims + s;
          if (h > r.length)
      ...
      var Ul, Rl, Zs, Qs, Xs = k(() => {
        ...
        ${_.setByOffset("global_idx", "dequantized_data")};
          ...
          let n = e.inputs;
          Ul(n, t), e.compute(Rl(e.inputs, t));
        }, Qs = (e) => N({ blockSize: e.blockSize, gatherAxis: e.gatherAxis, quantizeAxis: e.quantizeAxis });
      });
      var Vl, Nl, Ys, Js, ea = k(() => {
        "use strict";
        V();
        q();
        ie();
      ...
      ${f.setByOffset("global_idx", "value")};
        ...
        }, Ys = (e) => N({ axis: e.axis }), Js = (e, t) => {
          let n = e.inputs;
          Vl(n), e.compute(Nl(e.inputs, t));
        };
      });
      var Ll, Wl, ta, na, ra = k(() => {
        "use strict";
        V();
        q();
        K();
        Ll = (e) => {
          ...
          let n = e[0].dims.slice(), r = e[1].dims.slice(), [o, i, s] = Gt.getShapeOfGemmResult(n, t.transA, r, t.transB, e.length === 3 ? e[2].dims : void 0), a = [o, i];
          if (!a)
  ...
  ${y.mainStart([u, u, 1])}
    ...
    if (m < uniforms.M && n < uniforms.N) {
      output[m * uniforms.N + n] = value;
          ...
          Ll(e.inputs), e.compute(Wl(e.inputs, t));
        };
      });
      var Ne, Ke, it, st, Gl, Hl, ql, Fl, Kl, jl, Zl, Ql, oa, ia, sa = k(() => {
        "use strict";
        V();
        q();
        ie();
        K();
        [Ne, Ke, it, st] = [0, 1, 2, 3], Gl = (e) => {
          if (e[0].dims.length !== 4)
...
`, Zl = (e, t, n) => (() => {
        ...
        `;
        ...
        })() + `${e.setByOffset("global_idx", "result")}`, Ql = (e, t) => {
          ...
          t.format === "NHWC" && (i = [e[0].dims[0], e[1].dims[1], e[1].dims[2], e[0].dims[3]], [Ne, Ke, it, st] = [0, 3, 1, 2]);
  ...
  ${c.mainStart()}
    ${c.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${Zl(s, a, t)}
          ...
          Gl(e.inputs), e.compute(Ql(e.inputs, t));
        }, ia = (e) => N({ alignCorners: e.align_corners, mode: e.mode, paddingMode: e.padding_mode, format: e.format });
      });
      var ge, Jl, ua, aa, ec, _t, da, sr = k(() => {
        "use strict";
        V();
        q();
        ie();
        ...
        K();
        Ve();
        ge = (e, t) => e.length > t && e[t].dims.length > 0 ? e[t] : void 0, Jl = (e, t) => {
        ...
        }, ua = (e) => N({ ...e }), aa = N({ perm: [0, 2, 1, 3] }), ec = (e, t, n, r, o, i, s) => {
  ...
  ${c.mainStart()}
    ...
    qkv_with_bias[global_idx] = qkv[global_idx] + bias[bias_offset_idx];
          ...
          if (s && x.size(s.dims) > 0) {
            ...
            return u = ec(e, i, s, t, r, n * o, a), u = u.reshape([t, r, n, o]), n === 1 || r === 1 ? u : e.compute(pe(u, aa.perm), { inputs: [u], outputs: [-1] })[0];
          } else
            return i.dims.length === 3 && (u = i.reshape([t, r, n, o])), n === 1 || r === 1 ? u : e.compute(pe(u, aa.perm), { inputs: [u], outputs: [-1] })[0];
        }, da = (e, t) => {
          let n = Jl(e.inputs, t), r = e.inputs[0], o = ge(e.inputs, 1), i = ge(e.inputs, 2), s = ge(e.inputs, 3), a = ge(e.inputs, 4), u = ge(e.inputs, 5), d = ge(e.inputs, 6), l = ge(e.inputs, 7);
          if (r.dims.length === 5)
          ...
          if (c)
            return ot(e, p, o, i, a, void 0, d, l, u, n);
          if (!o || !i)
          ...
          ot(e, p, f, m, a, void 0, d, l, u, n);
        };
      });
      var tc, nc, rc, oc, ar, la, ca, ur = k(() => {
        "use strict";
        V();
        q();
        ie();
        ...
        tc = (e) => {
          ...
          return e[1].dims[0] > 0 && (e[1].getBigInt64Array().forEach((o) => n.push(Number(o))), r = n.length), N({ numOutputs: r, axis: t.axis, splitSizes: n });
        }, rc = (e) => `
...
`)}
    ...
    writeBufferData(output_number, indices, global_idx);
      ...
      var ic, cn, pa, dr = k(() => {
        ...
        ${b.mainStart(Ye)}
          ...
          return { name: "RotaryEmbedding", shaderCache: { hint: N({ interleaved: n }).cacheKey, inputDependencies: ["rank", "rank", "rank", "rank"] }, getShaderSource: h, getRunData: () => ({ outputs: [{ dims: e[0].dims, dataType: e[0].dataType }], dispatchGroup: { x: Math.ceil(x.size(p) / Ye) }, programUniforms: m }) };
        }, pa = (e, t) => {
          ic(e.inputs, t), e.compute(cn(e.inputs, t));
        };
      });
      var sc, ac, ma, uc, fa, ha = k(() => {
        "use strict";
        ie();
        V();
        en();
        ...
        }, ac = N({ perm: [0, 2, 1, 3] }), ma = (e, t, n) => {
          let r = t, o = n.kvNumHeads;
          return t.dims.length === 3 && n.kvSequenceLength !== 0 && (r = t.reshape([n.batchSize, n.kvSequenceLength, o, n.headSize]), r = e.compute(pe(r, ac.perm), { inputs: [r], outputs: [-1] })[0]), r;
        }, uc = (e, t, n, r) => {
  ...
  `;
          ...
          if (((_a2 = e.inputs[1]) == null ? void 0 : _a2.dims.length) === 5)
            throw new Error("Packed KV is not implemented");
          let r = e.inputs[0], o = e.inputs[1] && e.inputs[1].dims.length > 0 ? e.inputs[1] : void 0, i = e.inputs[2] && e.inputs[2].dims.length > 0 ? e.inputs[2] : void 0, s = e.inputs[3] && e.inputs[3].dims.length !== 0 ? e.inputs[3] : void 0, a = e.inputs[4] && e.inputs[4].dims.length !== 0 ? e.inputs[4] : void 0, u = e.inputs.length > 4 ? e.inputs[5] : void 0, d = e.inputs.length > 5 ? e.inputs[6] : void 0, l = n.kvNumHeads ? n.kvNumHeads : n.numHeads, c = N({ axis: 2, numOutputs: 3, splitSizes: [n.numHeads * n.headSize, l * n.headSize, l * n.headSize] }), [p, f, m] = !o && !i ? e.compute(ar([r], c), { inputs: [r], outputs: [-1, -1, -1] }) : [r, o, i], h, b;
          if (t.doRotary) {
            let w = e.compute(uc(n.batchSize, n.sequenceLength, u, d), { inputs: [u, d], outputs: [-1] })[0], v = e.inputs[7], $ = e.inputs[8], T = N({ interleaved: t.rotaryInterleaved !== 0, numHeads: n.numHeads, rotaryEmbeddingDim: 0, scale: t.scale }), I = [p, w, v, $], A = [-1];
            h = e.compute(cn(I, T), { inputs: I, outputs: A })[0], I.splice(0, 1, f);
            let z = N({ interleaved: t.rotaryInterleaved !== 0, numHeads: n.kvNumHeads, rotaryEmbeddingDim: 0, scale: t.scale });
            b = e.compute(cn(I, z), { inputs: I, outputs: A })[0];
          }
          let y = _t(e, n.batchSize, n.numHeads, n.sequenceLength, n.headSize, t.doRotary ? h : p, void 0, 0), g = ma(e, t.doRotary ? b : f, n), _ = ma(e, m, n);
          ot(e, y, g, _, void 0, void 0, s, a, void 0, n, u, d);
        };
      });
      var ga, dc, lc, ya, ba = k(() => {
        "use strict";
        V();
        q();
        Ve();
  ...
  ${g.mainStart(p)}
    ...
    if (local_idx == 0) {
      ...
      output[workgroup_index] = vec2f(channel_scale, channel_shift);
          ...
          let r = t[0].dims, o = r, i = 2, s = r[0], a = r[1], u = x.sizeFromDimension(r, i), d = X(u), l = x.size(o) / d, c = ga(e, t[0], t[1], t[2], s, u, a, n.epsilon), p = [s, a, u / d], f = [s, a], m = ["type", "none"], h = (b) => {
  ...
  ${b.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${_.setByOffset("global_idx", "value")};
          ...
          let r = t[0].dims, o = r, i = r[0], s = r[r.length - 1], a = x.sizeFromDimension(r, 1) / s, u = X(s), d = x.size(o) / u, l = [{ type: 12, data: a }, { type: 12, data: Math.floor(s / u) }], c = ["type", "type"], p = false, f = [0, r.length - 1];
          for (let y = 0; y < r.length - 2; y++)
            p = p || r[y + 1] !== 1, f.push(y + 1);
          p = p && r[r.length - 1] !== 1;
          let m = p ? e.compute(pe(e.inputs[0], f), { inputs: [e.inputs[0]], outputs: [-1] })[0] : e.inputs[0].reshape(Array.from({ length: r.length }, (y, g) => r[f[g]])), h = ga(e, m, t[1], t[2], i, a, s, n.epsilon), b = (y) => {
    ...
    ${g ? "inv_std_output[global_idx] = inv_std_dev" : ""};
      ...
      var mc, $a, va = k(() => {
        ...
        mc = (e) => {
          ...
          if (n < 8 && r < 8)
            e.compute(sn(e.inputs, { activation: "" }, t));
          else {
            ...
            if (i !== 1 && o === 1 && s === 1) {
              ...
              e.compute(bt(e.inputs, { activation: "" }, t));
          }
        };
      });
      var fc, hc, gc, xa, Sa, Ta = k(() => {
        "use strict";
        V();
        q();
        ie();
        ...
        fc = (e, t) => {
          ...
          let n = e[0].dims, r = n.length, o = n[r - 2], i = t.k, s = t.n, a = n.slice(0, r - 2), u = x.size(a), l = e[1].dims[2] / 4, c = e[0].dataType, p = X(t.k), f = X(l), m = X(s), h = a.concat([o, s]), b = o > 1 && s / m % 2 === 0 ? 2 : 1, y = x.size(h) / m / b, g = 64, _ = [], w = [u, o, i / p], v = x.convertShape(e[1].dims).slice();
          v.splice(-1, 1, l / f), _.push(...P(w)), _.push(...P(v)), _.push(...P(e[2].dims)), e.length === 4 && _.push(...P(x.convertShape(e[3].dims)));
          let $ = [u, o, s / m];
          _.push(...P($));
          let T = (I) => {
            let A = w.length, z = S("a", e[0].dataType, A, p), M = S("b", 12, v.length, f), U = S("scales", e[2].dataType, e[2].dims.length), G = [z, M, U], B = e.length === 4 ? S("zero_points", 12, e[3].dims.length) : void 0;
            B && G.push(B);
            let ee = $.length, W = C("output", e[0].dataType, ee, m), D = re(e[0].dataType), Z = (() => {
              switch (p) {
                case 1:
                  return `array<${D}, 8>`;
                case 2:
        ...
        ${I.mainStart([g, 1, 1])}
          ...
          let n = e[0].dims, r = n.length, o = n[r - 2], i = t.k, s = t.n, a = n.slice(0, r - 2), u = x.size(a), l = e[1].dims[2] / 4, c = e[0].dataType, p = X(t.k), f = X(l), m = a.concat([o, s]), h = 128, b = s % 8 === 0 ? 8 : s % 4 === 0 ? 4 : 1, y = h / b, g = y * f * 8, _ = g / p, w = g / t.blockSize, v = x.size(m) / b, $ = [], T = [u, o, i / p], I = x.convertShape(e[1].dims).slice();
          I.splice(-1, 1, l / f), $.push(...P(T)), $.push(...P(I)), $.push(...P(e[2].dims)), e.length === 4 && $.push(...P(x.convertShape(e[3].dims)));
          let A = [u, o, s];
          $.push(...P(A));
          let z = (M) => {
            let U = T.length, G = S("a", e[0].dataType, U, p), B = S("b", 12, I.length, f), ee = S("scales", e[2].dataType, e[2].dims.length), W = [G, B, ee], D = e.length === 4 ? S("zero_points", 12, e[3].dims.length) : void 0;
            D && W.push(D);
            let Z = A.length, R = C("output", e[0].dataType, Z), Q = re(e[0].dataType), we = () => {
              switch (p) {
                case 1:
                  return `
        ...
        ${M.mainStart([y, b, 1])}
          ...
          fc(e.inputs, t), t.blockSize === 32 && e.adapterInfo.isVendor("intel") && e.adapterInfo.isArchitecture("gen-12lp") ? e.compute(gc(e.inputs, t)) : e.compute(hc(e.inputs, t));
        }, Sa = (e) => N(e);
      });
      var yc, bc, _c, wc, $c, vc, xc, Sc, Ia, Ca = k(() => {
        "use strict";
        V();
        q();
        K();
      ...
      `;
          ...
          let a = ["rank"], u = (d) => {
            let l = C("output", e[0].dataType, n.length), c = S("x", e[0].dataType, r.length), p = c.type.value, f = vc(l, r.length, t), m = [{ name: "output_size", type: "u32" }, { name: "pads", type: "i32", length: t.pads.length }];
      ...
      var pn, Aa, Ea, ka, Pa, Tc, Ic, za, Ba, Da, Oa, Ma, Ua, Ra, Va, Na, La, Wa, Ga, Ha = k(() => {
        "use strict";
        ye();
        V();
        q();
        ...
        pn = (e) => {
          ...
          let l = Xe.computePoolOutputShape(n, o, a, u, s, d, t.autoPad), c = Object.assign({}, t);
        ...
        }, Pa = (e) => `${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`, Tc = (e) => `${Pa(e)};${e.countIncludePad}`, Ic = (e) => `${Pa(e)};${e.storageOrder};${e.dilations}`, za = (e) => ({ format: e.format, autoPad: ["NOTSET", "VALID", "SAME_UPPER", "SAME_LOWER"][e.auto_pad], ceilMode: e.ceil_mode, kernelShape: e.kernel_shape, strides: e.strides, pads: e.pads }), Ba = (e, t, n, r) => {
          let [o, i] = Aa(t, r, n), s = S("x", t.dataType, t.dims.length), a = s.type.value, u = "value += x_val;", d = "";
          o.countIncludePad ? d += `value /= ${a}(uniforms.kernelSize);` : d += `value /= ${a}(i32(uniforms.kernelSize) - pad);`;
          let [l, c, p, f, m] = Ea(i, o);
          l.push(...P(t.dims, i));
          let h = ["rank"];
          return { name: e, shaderCache: { hint: `${r.cacheKey};${p};${f};${m}`, inputDependencies: h }, getRunData: () => ({ outputs: [{ dims: i, dataType: t.dataType }], dispatchGroup: { x: Math.ceil(x.size(i) / 64) }, programUniforms: l }), getShaderSource: (b) => ka(b, s, t.dims.length, i.length, o, u, d, 0, c, p, f, m) };
        }, Da = (e) => {
          let t = e.count_include_pad !== 0, n = za(e);
          if (n.ceilMode !== 0)
            throw new Error("using ceil() in shape computation is not yet supported for AveragePool");
          let r = { countIncludePad: t, ...n, cacheKey: "" };
          return { ...r, cacheKey: Tc(r) };
        }, Oa = (e, t) => {
          pn(e.inputs), e.compute(Ba("AveragePool", e.inputs[0], false, t));
        }, Ma = { autoPad: "", ceilMode: 0, countIncludePad: false, kernelShape: [], strides: [], pads: [], storageOrder: 0, dilations: [] }, Ua = (e) => {
          let t = e.format;
          return { format: t, ...Ma, cacheKey: t };
        }, Ra = (e, t) => {
          pn(e.inputs), e.compute(Ba("GlobalAveragePool", e.inputs[0], true, t));
        }, Va = (e, t, n, r) => {
          let [o, i] = Aa(t, r, n), s = `
      value = max(x_val, value);
    `, a = "", u = S("x", t.dataType, t.dims.length), d = ["rank"], [l, c, p, f, m] = Ea(i, o);
          return l.push(...P(t.dims, i)), { name: e, shaderCache: { hint: `${r.cacheKey};${p};${f};${m}`, inputDependencies: d }, getRunData: () => ({ outputs: [{ dims: i, dataType: t.dataType }], dispatchGroup: { x: Math.ceil(x.size(i) / 64) }, programUniforms: l }), getShaderSource: (h) => ka(h, u, t.dims.length, i.length, o, s, a, t.dataType === 10 ? -65504 : -1e5, c, p, f, m) };
        }, Na = (e, t) => {
          pn(e.inputs), e.compute(Va("MaxPool", e.inputs[0], false, t));
        }, La = (e) => {
          let t = e.storage_order, n = e.dilations, r = za(e);
          if (t !== 0)
          ...
          pn(e.inputs), e.compute(Va("GlobalMaxPool", e.inputs[0], true, t));
        };
      });
      var Ac, Ec, qa, Fa, Ka = k(() => {
        "use strict";
        V();
        q();
        ie();
        ...
        Ac = (e, t) => {
          ...
          let n = x.normalizeAxis(t.axis, e[0].dims.length), r = e[0].dataType, o = r === 3, i = e[0].dims, s = e[1].dataType, a = x.size(i), u = r === 3 || r === 2, d = u ? [Math.ceil(x.size(e[0].dims) / 4)] : e[0].dims, l = e[1].dims, c = e.length > 2 ? e[2] : void 0, p = c ? u ? [Math.ceil(x.size(c.dims) / 4)] : c.dims : void 0, f = l.length === 0 || l.length === 1 && l[0] === 1, m = f === false && l.length === 1, h = X(a), b = f && (!u || h === 4), y = b ? h : 1, g = b && !u ? h : 1, _ = S("input", u ? 12 : r, d.length, g), w = S("scale", s, l.length), v = c ? S("zero_point", u ? 12 : r, p.length) : void 0, $ = C("output", s, i.length, y), T = [_, w];
          v && T.push(v);
          let I = [d, l];
          c && I.push(p);
          let A = [{ type: 12, data: a / y }, { type: 12, data: n }, { type: 12, data: t.blockSize }, ...P(...I, i)], z = (M) => {
            let U = [{ name: "output_size", type: "u32" }, { name: "axis", type: "u32" }, { name: "block_size", type: "u32" }];
            return `
      ...
      ${$.setByOffset("global_idx", `${$.type.value}(x_value - zero_point_value) * scale_value`)};
          ...
          Ac(e.inputs, t), e.compute(Ec(e.inputs, t));
      ...
      var kc, Pc, ja, Za = k(() => {
        ...
        output[global_idx] = uniforms.start + ${c}(global_idx) * uniforms.delta;
          ...
          let t = 0, n = 0, r = 0;
          e.inputs[0].dataType === 6 ? (t = e.inputs[0].getInt32Array()[0], n = e.inputs[1].getInt32Array()[0], r = e.inputs[2].getInt32Array()[0]) : e.inputs[0].dataType === 1 && (t = e.inputs[0].getFloat32Array()[0], n = e.inputs[1].getFloat32Array()[0], r = e.inputs[2].getFloat32Array()[0]), te.webgpu.validateInputContent && kc(t, n, r), e.compute(Pc(t, n, r, e.inputs[0].dataType), { inputs: [] });
        };
      });
      var zc, Bc, Qa, Xa, Ya = k(() => {
        "use strict";
        V();
        q();
        ie();
        ...
        zc = (e, t, n, r) => {
          ...
          let n = e[0].dims, r = e[1].dims, o = n, i = 1, s = Math.ceil(x.sizeToDimension(r, r.length - 1) / i), a = r[r.length - 1], u = x.sizeFromDimension(n, a), d = [{ type: 12, data: s }, { type: 12, data: a }, { type: 12, data: u }, ...P(e[1].dims, e[2].dims, o)], l = (c) => {
            let p = S("indices", e[1].dataType, e[1].dims.length), f = S("updates", e[2].dataType, e[2].dims.length, i), m = t.reduction !== "none" && t.reduction !== "" ? So("output", e[0].dataType, o.length) : C("output", e[0].dataType, o.length, i);
            return `
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${zc(t.reduction, "output[data_offset + i]", "value", m.type.value)}
        ...
        }, Qa = (e) => N({ reduction: e.reduction }), Xa = (e, t) => {
          e.compute(Bc(e.inputs, t), { inputs: [e.inputs[1], e.inputs[2]], outputs: [] });
        };
      });
      var Dc, Oc, Mc, Ja, Uc, Rc, Vc, Nc, Lc, Wc, Gc, Hc, eu, qc, Fc, Kc, jc, Zc, tu, nu, ru = k(() => {
        "use strict";
        V();
        q();
        ie();
        ...
        Dc = (e, t) => {
          ...
          if (a > 0 && e.length > a && e[a].dims.length === 1 && e[a].dims[0] > 0) {
            ...
            Dc(r, t), t.axes.length > 0 && Oc(r, t.axes, d).forEach((l, c) => r[c] = l);
          }
...
`, Uc = (e, t) => `fn getOriginalCoordinateFromResizedCoordinate(xResized: u32, xScale: f32, lengthResized: u32,
     lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${t} { ` + (() => {
        ...
        })() + "}", Rc = (e, t, n) => `fn getNearestPixelFromOriginal(xOriginal: ${n}, isDownSample: bool) -> ${n} {` + (() => {
          switch (e) {
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${m} {
    ...
    depth = max(0, min(depth, ${n[a]} - 1));
      ...
      return (x111 * dx2 * dy2 * dz2 + x112 * dx2 * dy2 * dz1 + x121 * dx2 * dy1 *dz2 + x122 * dx2 * dy1 * dz1 +
          ...
          let s = e.dims, a = Vc(i, t.axes, s.length), u = Nc(s, r, o, t.axes), d = r.slice();
          r.length === 0 && (d = s.map((g, _) => g === 0 ? 1 : u[_] / g), t.keepAspectRatioPolicy !== "stretch" && (u = Lc(s, d, t)));
...
`}
          ...
          return N({ antialias: t, axes: n, coordinateTransformMode: r, cubicCoeffA: o, excludeOutside: i, extrapolationValue: s, keepAspectRatioPolicy: a, mode: u, nearestMode: d });
        };
      });
      var Qc, Xc, ou, iu = k(() => {
        "use strict";
        ...
        Qc = (e) => {
          ...
          let o = t.simplified, i = e[0].dims, s = x.size(i), a = i, u = s, d = i.slice(-1)[0], l = r ? i.slice(0, -1).concat(1) : [], c = !o && e.length > 3, p = e.length > 4, f = r && n > 1, m = r && n > 2, h = n > 3, b = 64, y = X(d), g = [{ type: 12, data: u }, { type: 12, data: y }, { type: 12, data: d }, { type: 1, data: t.epsilon }], _ = (v) => {
      ...
      ${v.mainStart([b, 1, 1])}
        ...
        for (var i: u32 = 0; i < stride; i++) {
          ...
          Qc(e.inputs);
          let r = [0];
          e.outputCount > 1 && r.push(-3), e.outputCount > 2 && r.push(-3), e.outputCount > 3 && r.push(3), e.compute(Xc(e.inputs, t, e.outputCount, false), { outputs: r });
        };
      });
      var Yc, mn, Jc, su, ep, tp, au, uu, du = k(() => {
        "use strict";
        V();
        q();
        ie();
        ...
        Yc = (e, t) => {
          ...
          if (e.length > 1) {
            let n = mn(e, 1), r = mn(e, 2), o = mn(e, 3);
            return o.length === 0 && (o = [...Array(e[0].dims.length).keys()]), N({ starts: n, ends: r, axes: o });
          } else
            return t;
        }, su = (e, t, n, r, o) => {
          let i = e;
          return e < 0 && (i += n[r[t]]), o[t] < 0 ? Math.max(0, Math.min(i, n[r[t]] - 1)) : Math.max(0, Math.min(i, n[r[t]]));
        }, ep = (e, t, n) => `fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
          ...
          let n = e[0].dims, r = x.size(n), o = t.axes.length > 0 ? x.normalizeAxes(t.axes, n.length) : [...Array(n.length).keys()], i = mn(e, 4);
          i.forEach((y) => y !== 0 || (() => {
            throw new Error("step cannot be 0");
          })), i.length === 0 && (i = Array(o.length).fill(1));
          let s = t.starts.map((y, g) => su(y, g, n, o, i)), a = t.ends.map((y, g) => su(y, g, n, o, i));
      ...
      var np, rp, lu, cu, pu = k(() => {
        ...
        np = (e) => {
          ...
          p === 1 && (h = 256);
          let b = (T, I) => I === 4 ? `max(max(${T}.x, ${T}.y), max(${T}.z, ${T}.w))` : I === 2 ? `max(${T}.x, ${T}.y)` : I === 3 ? `max(max(${T}.x, ${T}.y), ${T}.z)` : T, y = S("x", u.dataType, u.dims, f), g = C("result", u.dataType, u.dims, f), _ = y.type.value, w = re(u.dataType) === "f32" ? `var threadMax = ${_}(-3.402823e+38f);` : `var threadMax = ${_}(-65504.0h);`, v = (T) => `
      ...
      var mu, op, ip, sp, fu, hu = k(() => {
        "use strict";
        V();
        q();
        K();
        mu = (e) => Array.from(e.getBigInt64Array(), Number), op = (e) => {
          if (!e || e.length !== 2)
          ...
          let n = e[0].dims, r = t ?? mu(e[1]), o = ip(n, r), i = x.size(o), s = e[0].dataType, a = S("input", s, n.length), u = C("output", s, o.length), d = (l) => `
      ...
      var ap, up, gu, yu = k(() => {
        ...
        ${d}
          ...
          let u = Math.ceil(a / 4);
          return { name: "Where", shaderCache: { inputDependencies: ["rank", "rank", "rank"] }, getShaderSource: (d) => ap(d, e, s, i, o), getRunData: () => ({ outputs: [{ dims: s, dataType: o }], dispatchGroup: { x: Math.ceil(a / 64 / 4) }, programUniforms: [{ type: 12, data: u }, ...P(r, t, n, s)] }) };
        }, gu = (e) => {
      ...
      var fn, wu = k(() => {
        ...
        fn = class {
          ...
          build(t, n) {
            ...
            let s = To(n, this.backend.device.limits), a = t.getShaderSource(s), u = `${o.join(`
`)}
...
${a}`, d = r.createShaderModule({ code: u, label: t.name });
      ...
      var $u = {};
      nt($u, { WebGpuBackend: () => cr });
      var dp, lp, lr, cr, vu = k(() => {
        "use strict";
        ye();
        V();
        ke();
        ...
        dp = (e, t) => {
          ...
          var _a2, _b;
          let r = e.name;
          return ((_a2 = e.shaderCache) == null ? void 0 : _a2.hint) && (r += "[" + e.shaderCache.hint + "]"), r += ":" + n + `:${dp(t, ((_b = e.shaderCache) == null ? void 0 : _b.inputDependencies) ?? new Array(t.length).fill("dims"))}`, r;
        }, lr = class {
          constructor(t) {
          ...
          async initialize(t, n) {
            ...
            i("chromium-experimental-timestamp-query-inside-passes") || i("timestamp-query"), i("shader-f16"), i("subgroups"), this.device = await n.requestDevice(o), this.adapterInfo = new lr(n.info || await n.requestAdapterInfo()), this.gpuDataManager = vo(this), this.programManager = new fn(this), this.kernels = /* @__PURE__ */ new Map(), this.kernelPersistentData = /* @__PURE__ */ new Map(), this.kernelCustomData = /* @__PURE__ */ new Map(), Wt(t.logLevel, !!t.debug), this.device.onuncapturederror = (s) => {
            ...
            this.queryType !== "none" && (this.commandEncoder.resolveQuerySet(this.querySet, 0, this.pendingDispatchNumber * 2, this.queryResolveBuffer, 0), t = this.device.createBuffer({ size: this.pendingDispatchNumber * 2 * 8, usage: GPUBufferUsage.MAP_READ | GPUBufferUsage.COPY_DST }), this.pendingQueries.set(t, this.pendingKernels), this.pendingKernels = [], this.commandEncoder.copyBufferToBuffer(this.queryResolveBuffer, 0, t, 0, this.pendingDispatchNumber * 2 * 8)), this.device.queue.submit([this.commandEncoder.finish()]), this.gpuDataManager.refreshPendingBuffers(), this.commandEncoder = null, this.pendingDispatchNumber = 0, this.queryType !== "none" && t.mapAsync(GPUMapMode.READ).then(() => {
              ...
              for (let o = 0; o < n.length / 2; o++) {
                ...
                if ((_a2 = this.env.webgpu.profiling) == null ? void 0 : _a2.ondata)
                  this.env.webgpu.profiling.ondata({ version: 1, inputsMetadata: c.map((y) => ({ dims: y.dims, dataType: Ee(y.dataType) })), outputsMetadata: p.map((y) => ({ dims: y.dims, dataType: Ee(y.dataType) })), kernelId: s, kernelType: u, kernelName: d, programName: l, startTime: h, endTime: b });
                else {
                  let y = "";
                  c.forEach((_, w) => {
          ...
          run(t, n, r, o, i, s) {
            ...
            if (l) {
              ...
              l.forEach((I) => {
                ...
                if (A.length === 0)
                  return;
                let z = I.type === 10 ? 2 : 4, M, U;
                I.type === 10 ? (U = A.length > 4 ? 16 : A.length > 2 ? 8 : A.length * z, M = A.length > 4 ? 16 : z * A.length) : (U = A.length <= 2 ? A.length * z : 16, M = 16), _ = Math.ceil(_ / U) * U, w.push(_);
                let G = I.type === 10 ? 8 : 4;
              ...
              l.forEach((I, A) => {
                let z = w[A], M = typeof I.data == "number" ? [I.data] : I.data;
                if (I.type === 6)
                  ...
                  throw new Error(`Unsupported uniform type: ${Ee(I.type)}`);
              });
            ...
            let h = this.programManager.normalizeDispatchGroupSize(d), b = h[1] === 1 && h[2] === 1, y = lp(t, n, b), g = this.programManager.getArtifact(y);
            if (g || (g = this.programManager.build(t, h), this.programManager.setArtifact(y, g), j("info", () => `[artifact] key: ${y}, programName: ${t.name}`)), l && g.uniformVariablesInfo) {
              ...
              for (let _ = 0; _ < l.length; _++) {
                ...
                if (v !== T || $ !== I)
                  throw new Error(`Uniform variable ${_} mismatch: expect type ${T} with size ${I}, got type ${v} with size ${$} in program "${g.programInfo.name}".`);
              }
            }
            if (j("info", () => `[ProgramManager] run "${t.name}" (key=${y}) with ${h[0]}x${h[1]}x${h[2]}`), this.queryType !== "none" || this.sessionStatus === "capturing") {
          ...
          computeKernel(t, n, r) {
            ...
            this.currentKernelId = t, u[0] && (u[1] = u[0](u[1]), u[0] = void 0), j("info", () => `[WebGPU] Start to run kernel "[${i}] ${s}"...`);
          ...
          captureBegin() {
            j("info", "captureBegin"), this.capturedCommandList.get(this.currentSessionId) || this.capturedCommandList.set(this.currentSessionId, []), this.capturedPendingKernels.get(this.currentSessionId) || this.capturedPendingKernels.set(this.currentSessionId, []), this.flush(), this.sessionStatus = "capturing";
          }
          captureEnd() {
      ...
      var wt, pr, cp, Su = k(() => {
        ...
        wt = class e {
          ...
          compute(t, n) {
            var _a2;
            let r = ((_a2 = n == null ? void 0 : n.inputs) == null ? void 0 : _a2.map((a) => typeof a == "number" ? this.inputs[a] : a)) ?? this.inputs, o = (n == null ? void 0 : n.outputs) ?? [], i = (a, u, d) => new wt(this.module, u, this.output(a, d), d), s = (a, u) => {
              let d = qe(a, u);
              if (!d)
          ...
          if (e === "webgpu") {
            let i = (vu(), dt($u)).WebGpuBackend, s = new i();
            await s.initialize(n, r), o("webgpu", [s, (a) => s.alloc(Number(a)), (a) => s.free(a), (a, u, d, l = false) => {
              if (l)
                j("verbose", () => `[WebGPU] jsepCopyGpuToGpu: src=${Number(a)}, dst=${Number(u)}, size=${Number(d)}`), s.memcpy(Number(a), Number(u));
              else {
                j("verbose", () => `[WebGPU] jsepCopyCpuToGpu: dataOffset=${Number(a)}, gpuDataId=${Number(u)}, size=${Number(d)}`);
                let c = t.HEAPU8.subarray(Number(a >>> 0), Number(a >>> 0) + Number(d));
                s.upload(Number(u), c);
              }
            }, async (a, u, d) => {
              j("verbose", () => `[WebGPU] jsepCopyGpuToCpu: gpuDataId=${a}, dataOffset=${u}, size=${d}`), await s.download(Number(a), () => t.HEAPU8.subarray(Number(u) >>> 0, Number(u + d) >>> 0));
            }, (a, u, d) => s.createKernel(a, Number(u), d, t.UTF8ToString(t._JsepGetNodeName(Number(u)))), (a) => s.releaseKernel(a), (a, u, d, l) => {
              j("verbose", () => `[WebGPU] jsepRun: sessionHandle=${d}, kernel=${a}, contextDataOffset=${u}`);
      ...
      var pp, Et, kt, et, mp, Tu, pt, Pt, zt, Iu, Bt, Dt, Ot, An = k(() => {
        "use strict";
        ye();
        oo();
        so();
        ...
        pp = (e, t) => {
          ...
          pp(e.wasm.numThreads, ft(e.logLevel));
        }, kt = async (e, t) => {
          var _a2, _b;
          (_b = (_a2 = ne()).asyncInit) == null ? void 0 : _b.call(_a2);
          ...
          try {
            if ([s, u] = await io(t), (t == null ? void 0 : t.externalData) && o.mountExternalData) {
              let w = [];
            ...
            for (let w of (t == null ? void 0 : t.executionProviders) ?? [])
              if ((typeof w == "string" ? w : w.name) === "webnn") {
                if (o.shouldTransferToMLTensor = false, typeof w != "string") {
                  let $ = w, T = $ == null ? void 0 : $.context, I = $ == null ? void 0 : $.gpuDevice, A = $ == null ? void 0 : $.deviceType, z = $ == null ? void 0 : $.powerPreference;
            ...
            i = await o._OrtCreateSession(n, r, s), (_a2 = o.webgpuOnCreateSession) == null ? void 0 : _a2.call(o, i), i === 0 && Y("Can't create a session."), (_b = o.jsepOnCreateSession) == null ? void 0 : _b.call(o), o.currentContext && (o.webnnRegisterMLContext(i, o.currentContext), o.currentContext = void 0, o.shouldTransferToMLTensor = true);
            let [c, p] = mp(i), f = !!(t == null ? void 0 : t.enableGraphCapture), m = [], h = [], b = [], y = [], g = [];
            for (let w = 0; w < c; w++) {
              let [v, $, T] = Tu(i, w);
            ...
            for (let w = 0; w < p; w++) {
              ...
              h.push(I), y.push($ === 0 ? { name: I, isTensor: false } : { name: I, isTensor: true, type: Ee($), shape: T });
              {
                ...
                let A = typeof (t == null ? void 0 : t.preferredOutputLocation) == "string" ? t.preferredOutputLocation : ((_c2 = t == null ? void 0 : t.preferredOutputLocation) == null ? void 0 : _c2[I]) ?? "cpu", z = o.webnnIsGraphOutput;
                if (A === "cpu" && z && z(i, I)) {
            ...
            let _ = null;
            return g.some((w) => w === "gpu-buffer" || w === "ml-tensor" || w === "ml-tensor-cpu-output") && (a = o._OrtCreateBinding(i), a === 0 && Y("Can't create IO binding."), _ = { handle: a, outputPreferredLocations: g, outputPreferredLocationsEncoded: g.map((w) => w === "ml-tensor-cpu-output" ? "ml-tensor" : w).map((w) => zn(w)) }), et.set(i, [i, d, l, _, f, false]), [i, m, h, b, y];
          } catch (c) {
            ...
            o._free(n), s !== 0 && o._OrtReleaseSessionOptions(s) !== 0 && Y("Can't release session options."), u.forEach((c) => o._free(c)), (_d2 = o.unmountExternalData) == null ? void 0 : _d2.call(o);
          }
        }, zt = (e) => {
          var _a2, _b, _c2;
          let t = ne(), n = et.get(e);
          ...
          let [r, o, i, s, a] = n;
          s && (a && t._OrtClearBoundOutputs(s.handle) !== 0 && Y("Can't clear bound outputs."), t._OrtReleaseBinding(s.handle) !== 0 && Y("Can't release IO binding.")), (_a2 = t.jsepOnReleaseSession) == null ? void 0 : _a2.call(t, e), (_b = t.webnnOnReleaseSession) == null ? void 0 : _b.call(t, e), (_c2 = t.webgpuOnReleaseSession) == null ? void 0 : _c2.call(t, e), o.forEach((u) => t._OrtFree(u)), i.forEach((u) => t._OrtFree(u)), t._OrtReleaseSession(r) !== 0 && Y("Can't release session."), et.delete(e);
        }, Iu = async (e, t, n, r, o, i, s = false) => {
          if (!e) {
            t.push(0);
            return;
          }
          ...
          try {
            ...
            let y = a._OrtCreateTensor(He(d), f, m, b, l.length, zn(p));
          ...
          var _a2, _b, _c2, _d2;
          let s = ne(), a = s.PTR_SIZE, u = et.get(e);
          if (!u)
            throw new Error(`cannot run inference. invalid session id: ${e}`);
          let d = u[0], l = u[1], c = u[2], p = u[3], f = u[4], m = u[5], h = t.length, b = r.length, y = 0, g = [], _ = [], w = [], v = [], $ = s.stackSave(), T = s.stackAlloc(h * a), I = s.stackAlloc(h * a), A = s.stackAlloc(b * a), z = s.stackAlloc(b * a);
          try {
            [y, g] = ro(i), Ue("wasm prepareInputOutputTensor");
            for (let B = 0; B < h; B++)
              await Iu(n[B], _, v, e, l[t[B]], t[B], f);
            for (let B = 0; B < b; B++)
              await Iu(o[B], w, v, e, c[r[B]], h + r[B], f);
            Re("wasm prepareInputOutputTensor");
            for (let B = 0; B < h; B++)
              s.setValue(T + B * a, _[B], "*"), s.setValue(I + B * a, l[t[B]], "*");
            for (let B = 0; B < b; B++)
              s.setValue(A + B * a, w[B], "*"), s.setValue(z + B * a, c[r[B]], "*");
            if (p && !m) {
              let { handle: B, outputPreferredLocations: ee, outputPreferredLocationsEncoded: W } = p;
              if (l.length !== h)
              ...
              for (let D = 0; D < h; D++) {
                let Z = t[D];
                await s._OrtBindInput(B, l[Z], _[D]) !== 0 && Y(`Can't bind input[${D}] for session=${e}.`);
              }
              for (let D = 0; D < b; D++) {
                let Z = r[D];
                ((_a2 = o[D]) == null ? void 0 : _a2[3]) ? s._OrtBindOutput(B, c[Z], w[D], 0) !== 0 && Y(`Can't bind pre-allocated output[${D}] for session=${e}.`) : s._OrtBindOutput(B, c[Z], 0, W[Z]) !== 0 && Y(`Can't bind output[${D}] to ${ee[D]} for session=${e}.`);
              }
              Re("wasm bindInputsOutputs"), et.set(e, [d, l, c, p, f, true]);
            }
            (_b = s.jsepOnRunStart) == null ? void 0 : _b.call(s, d), (_c2 = s.webnnOnRunStart) == null ? void 0 : _c2.call(s, d);
            let M;
            p ? M = await s._OrtRunWithBinding(d, p.handle, b, A, y) : M = await s._OrtRun(d, I, T, h, z, b, A, y), M !== 0 && Y("failed to call OrtRun().");
            let U = [], G = [];
            ...
            for (let B = 0; B < b; B++) {
              ...
              let W = s.stackSave(), D = s.stackAlloc(4 * a), Z = false, R, Q = 0;
              try {
                s._OrtGetTensorData(ee, D, D + a, D + 2 * a, D + 3 * a) !== 0 && Y(`Can't access output tensor data on index ${B}.`);
                let se = a === 4 ? "i32" : "i64", H = Number(s.getValue(D, se));
                Q = s.getValue(D + a, "*");
                let E = s.getValue(D + a * 2, "*"), L = Number(s.getValue(D + a * 3, se)), oe = [];
                ...
                R = Ee(H);
                let Se = p == null ? void 0 : p.outputPreferredLocations[r[B]];
                if (R === "string") {
                  if (Se === "gpu-buffer" || Se === "ml-tensor")
                    throw new Error("String tensor is not supported on GPU.");
                  let ue = [];
                  for (let ae = 0; ae < $e; ae++) {
                    let Le = s.getValue(Q + ae * a, "*"), vt = s.getValue(Q + (ae + 1) * a, "*"), gr = ae === $e - 1 ? void 0 : vt - Le;
                    ue.push(s.UTF8ToString(Le, gr));
                  }
                  U.push([R, oe, ue, "cpu"]);
                } else if (Se === "gpu-buffer" && $e > 0) {
                  let ue = s.jsepGetBuffer;
                  if (!ue)
                    throw new Error('preferredLocation "gpu-buffer" is not supported without using WebGPU.');
                  let ae = ue(Q), Le = qe(H, $e);
                  if (Le === void 0 || !Nt(R))
                    throw new Error(`Unsupported data type: ${R}`);
                  Z = true, U.push([R, oe, { gpuBuffer: ae, download: s.jsepCreateDownloader(ae, Le, R), dispose: () => {
                    s._OrtReleaseTensor(ee) !== 0 && Y("Can't release tensor.");
                  } }, "gpu-buffer"]);
                } else if (Se === "ml-tensor" && $e > 0) {
                  let ue = s.webnnEnsureTensor, ae = s.webnnIsGraphInputOutputTypeSupported;
                  if (!ue || !ae)
                    throw new Error('preferredLocation "ml-tensor" is not supported without using WebNN.');
                  if (qe(H, $e) === void 0 || !Lt(R))
                    throw new Error(`Unsupported data type: ${R}`);
                  if (!ae(e, R, false))
                    throw new Error(`preferredLocation "ml-tensor" for ${R} output is not supported by current WebNN Context.`);
                  let vt = await ue(e, Q, H, oe, false);
                  Z = true, U.push([R, oe, { mlTensor: vt, download: s.webnnCreateMLTensorDownloader(Q, R), dispose: () => {
                    s.webnnReleaseTensorId(Q), s._OrtReleaseTensor(ee);
                  } }, "ml-tensor"]);
                } else if (Se === "ml-tensor-cpu-output" && $e > 0) {
                  let ue = s.webnnCreateMLTensorDownloader(Q, R)(), ae = U.length;
                  Z = true, G.push((async () => {
                    let Le = [ae, await ue];
                    return s.webnnReleaseTensorId(Q), s._OrtReleaseTensor(ee), Le;
                  })()), U.push([R, oe, [], "cpu"]);
                } else {
                  let ue = rt(R), ae = new ue($e);
                  new Uint8Array(ae.buffer, ae.byteOffset, ae.byteLength).set(s.HEAPU8.subarray(Q, Q + ae.byteLength)), U.push([R, oe, ae, "cpu"]);
                }
              } finally {
                s.stackRestore(W), R === "string" && Q && s._free(Q), Z || s._OrtReleaseTensor(ee);
              }
            }
            p && !f && (s._OrtClearBoundOutputs(p.handle) !== 0 && Y("Can't clear bound outputs."), et.set(e, [d, l, c, p, f, false]));
            for (let [B, ee] of await Promise.all(G))
              U[B][2] = ee;
            return Re("wasm ProcessOutputTensor"), U;
          } finally {
            (_d2 = s.webnnOnRunEnd) == null ? void 0 : _d2.call(s, d), s.stackRestore($), _.forEach((M) => s._OrtReleaseTensor(M)), w.forEach((M) => s._OrtReleaseTensor(M)), v.forEach((M) => s._free(M)), y !== 0 && s._OrtReleaseRunOptions(y), g.forEach((M) => s._free(M));
          }
        }, Dt = (e) => {
          let t = ne(), n = et.get(e);
          if (!n)
      ...
      var tt, xe, $t, gn, yn, hn, mr, fr, at, ut, hp, Cu, Au, Eu, ku, Pu, zu, Bu, hr = k(() => {
        "use strict";
        ye();
        An();
        Ge();
        Ct();
        tt = () => !!te.wasm.proxy && typeof document < "u", $t = false, gn = false, yn = false, fr = /* @__PURE__ */ new Map(), at = (e, t) => {
          let n = fr.get(e);
          ...
          switch (e.data.type) {
            case "init-wasm":
              $t = false, e.data.err ? (yn = true, mr[1](e.data.err)) : (gn = true, mr[0]()), hn && (URL.revokeObjectURL(hn), hn = void 0);
              break;
            case "init-ep":
            case "copy-from":
            case "create":
          ...
          if (!gn) {
            ...
            if ($t = true, tt())
              return new Promise((e, t) => {
                xe == null ? void 0 : xe.terminate(), eo().then(([n, r]) => {
                  try {
                    xe = r, xe.onerror = (i) => t(i), xe.onmessage = hp, mr = [e, t];
                    let o = { type: "init-wasm", in: te };
                    if (!o.in.wasm.wasmPaths && n) {
                      let i = Mt();
                      i && (o.in.wasm.wasmPaths = i);
                    }
                    xe.postMessage(o), hn = n;
                  } catch (o) {
                    t(o);
                  }
                }, t);
            ...
            try {
              await At(te.wasm), await Et(te), gn = true;
            } catch (e) {
              throw yn = true, e;
            } finally {
              $t = false;
          ...
          if (tt())
            return ut(), new Promise((t, n) => {
              at("init-ep", [t, n]);
              let r = { type: "init-ep", in: { epName: e, env: te } };
              xe.postMessage(r);
            });
          await kt(te, e);
        }, Eu = async (e) => tt() ? (ut(), new Promise((t, n) => {
          at("copy-from", [t, n]);
        ...
        Du = (e, t) => {
          ...
          switch (e[3]) {
            ...
            case "gpu-buffer": {
              ...
              return ve.fromGpuBuffer(n, { dataType: t, dims: e[1], download: r, dispose: o });
            }
            case "ml-tensor": {
              let t = e[0];
              if (!Lt(t))
              ...
              return ve.fromMLTensor(n, { dataType: t, dims: e[1], download: r, dispose: o });
            }
            default:
          ...
          async fetchModelAndCopyToWasmMemory(t) {
            return Eu(await ht(t));
          }
          async loadModel(t, n) {
            he();
            let r;
            typeof t == "string" ? r = await this.fetchModelAndCopyToWasmMemory(t) : r = t, [this.sessionId, this.inputNames, this.outputNames, this.inputMetadata, this.outputMetadata] = await ku(r, n), fe();
          }
          async dispose() {
          ...
          async run(t, n, r) {
            ...
            let u = o.map((p, f) => Du(p, () => `input "${this.inputNames[i[f]]}"`)), d = s.map((p, f) => p ? Du(p, () => `output "${this.outputNames[a[f]]}"`) : null), l = await zu(this.sessionId, i, u, a, d, r), c = {};
      ...
      var Uu = {};
      nt(Uu, { OnnxruntimeWebAssemblyBackend: () => _n, initializeFlags: () => Mu, wasmBackend: () => yp });
      var Mu, _n, yp, Ru = k(() => {
        "use strict";
        ye();
        hr();
        ...
        Mu = () => {
          ...
          if (typeof e != "boolean" && e !== void 0 && e !== "fixed" && e !== "relaxed" && (console.warn(`Property "env.wasm.simd" is set to unknown value "${e}". Reset it to \`false\` and ignore SIMD feature checking.`), te.wasm.simd = false), typeof te.wasm.proxy != "boolean" && (te.wasm.proxy = false), typeof te.wasm.trace != "boolean" && (te.wasm.trace = false), typeof te.wasm.numThreads != "number" || !Number.isInteger(te.wasm.numThreads) || te.wasm.numThreads <= 0)
            if (typeof self < "u" && !self.crossOriginIsolated)
              ...
              let t = typeof navigator > "u" ? $n("node:os").cpus().length : navigator.hardwareConcurrency;
      ...
      var _p = {};
      nt(_p, { InferenceSession: () => Nr, TRACE: () => ct, TRACE_EVENT_BEGIN: () => Ue, TRACE_EVENT_END: () => Re, TRACE_FUNC_BEGIN: () => he, TRACE_FUNC_END: () => fe, Tensor: () => ve, default: () => bp, env: () => te, registerBackend: () => We });
      ye();
      ye();
      ye();
      var Fr = "1.23.2";
      var bp = Cn;
      {
        let e = (Ru(), dt(Uu)).wasmBackend;
        We("webgpu", e, 5), We("webnn", e, 5), We("cpu", e, 10), We("wasm", e, 10);
      }
      Object.defineProperty(te.versions, "web", { value: Fr, enumerable: true });
      return dt(_p);
    })();
